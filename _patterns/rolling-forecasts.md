...
page_url: https://commons-os.github.io/patterns/rolling-forecasts/
github_url: https://github.com/commons-os/patterns/blob/main/_patterns/rolling-forecasts.md
slug: rolling-forecasts
title: Rolling Forecasts
aliases:
- Continuous Forecasting
- Perpetual Forecasting
version: 1.0
...
generalizes_from: []
specializes_to:
- pat_01kg5023zve6sv1r0bt9fxtm1t
enables: []
requires: []
related: []
contributors:
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_patterns/85-rolling-forecasts.md)
