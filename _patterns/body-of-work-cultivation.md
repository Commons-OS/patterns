...
# ═══════════════════════════════════════════════════════════════════
id: pat_019c8c2122167afdb69a82ae10
slug: body-of-work-cultivation
title: "Body of Work Cultivation"
aliases: ["Portfolio Building", "Cumulative Contribution", "Visible Track Record"]
summary: >-
...
# ═══════════════════════════════════════════════════════════════════
context_labels:
  corporate: "Professional Portfolio & Thought Leadership Assets"
  government: "Policy Impact Record & Institutional Memory"
  activist: "Campaign Archive & Movement Documentation"
  tech: "Open Source Contributions & Technical Blog"
  community: "Community Knowledge Base & Shared History"
...
ontology:
  domain: life
  cross_domains: [strategy, education, community]
  specification_layer: L1
  search_hints:
    primary_tension: "Ephemeral Effort vs. Compounding Legacy"
    vector_keywords: [portfolio, body of work, track record, visibility, legacy, compounding, contribution]
  commons_assessment:
    ...
    vitality: 4.2
    vitality_reasoning: >-
      A cultivated body of work is a living artifact that grows richer over time. It creates compounding returns in credibility, attracts aligned collaborators, and serves as a knowledge commons for others. Its vitality depends on the practitioner's continued investment and willingness to let it evolve.
    overall_score: 4.1
...
relationships:
  ...
  specializes_to: []
  enables:
    - {id: reputation-compounding, weight: 0.9, description: "A visible body of work is the primary fuel for reputation compounding."}
    - {id: knowledge-productization, weight: 0.8, description: "A rich body of work provides the raw material for productized knowledge assets."}
    - {id: offering-design, weight: 0.7, description: "Your body of work demonstrates what you can offer and builds the trust needed to sell it."}
  requires:
    - {id: ce-learning-in-public, weight: 0.8, description: "A body of work requires the discipline of making your thinking visible as you go."}
    - {id: purpose-articulation, weight: 0.7, description: "A coherent body of work requires a clear purpose to give it a through-line."}
  alternatives: []
  complementary:
    - {id: consistent-presence, weight: 0.8, description: "Consistent presence ensures your body of work reaches the people who need it."}
    - {id: method-documentation, weight: 0.7, description: "Documenting your method makes your body of work inspectable and reusable."}
  tools: []
...
graph_garden:
  ...
  entities: ["Austin Kleon", "Show Your Work", "Open Source Movement", "Academic Publishing", "Portfolio Theory", "Compound Interest"]
  communities: []
  inferred_links: []
