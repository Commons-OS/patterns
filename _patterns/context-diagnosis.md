...
id: pat_019c8c21221675f4954ca260b3
slug: context-diagnosis
title: "Context Diagnosis"
aliases: ["Situation Assessment", "System Mapping", "Reading the Field"]
summary: >-
...
context_labels:
  corporate: "Diagnosing team dynamics before a re-org."
  government: "Assessing community needs before a policy intervention."
  activist: "Mapping the power dynamics of a campaign."
  tech: "Understanding the user ecosystem before a product launch."
  community: "Sensing the health of a community before starting a new initiative."
...
ontology:
  ...
  search_hints:
    primary_tension: "Prescription before Diagnosis vs. Deep Inquiry"
    vector_keywords: [systems thinking, diagnosis, inquiry, context, situation assessment, mapping, sensemaking]
  commons_assessment:
    ...
    vitality: 4.5
    vitality_reasoning: >-
      This pattern is foundational for creating healthy, living systems. By deeply understanding the context, we can design interventions that are aligned with the existing life-energy, leading to greater vitality and resilience. It avoids the decay caused by imposing solutions that are disconnected from the reality of the system.
    overall_score: 3.5
...
relationships:
  ...
  - commons-engineer
  specializes_to: []
  enables: [{id: ce-leverage-point-identification, weight: 0.8, description: "Effective diagnosis reveals the most potent places to intervene."}, {id: purpose-articulation, weight: 0.6, description: "A clear context informs and sharpens the articulation of purpose."}]
  requires: [{id: systems-seeing, weight: 0.9, description: "Context diagnosis requires the ability to see the world in terms of interconnected systems."}]
  alternatives: []
  complementary: [{id: mental-model-externalization, weight: 0.7, description: "Externalizing mental models is a key tool for collective context diagnosis."}]
  tools: []

# GROUP 6: GRAPH GARDEN
graph_garden:
  last_pruned: 2026-02-23
  entities: ["organizational culture", "ecosystem health", "power dynamics", "feedback loops", "system archetypes", "stakeholder analysis"]
  communities: []
  inferred_links: []
...
1.  **Still the Instrument:** Before you can read the system, you must quiet your own internal noise. Acknowledge your biases, your desire for a quick fix, your pre-existing mental models. Create a space for genuine curiosity and open-ended inquiry. This is a form of meditative practice, preparing the ground for insight.

2.  **Gather the Stories:** Every system is a collection of stories. Talk to people. Listen to their experiences, their frustrations, their hopes. Don’t just collect data; collect narratives. Pay attention to the language they use, the metaphors that emerge, the recurring themes. These are the clues to the system’s underlying logic.

3.  **Map the Forces:** Use visual tools to make the invisible visible. Create a stakeholder map, a force-field analysis, a system diagram. Identify the key actors, the flows of resources, the feedback loops (both reinforcing and balancing). This is not about creating a perfect model, but about externalizing your understanding so that it can be shared and refined.

4.  **Identify the Tensions:** Where are the conflicts? Where are the paradoxes? Where is the system pulling in different directions at once? These tensions are not problems to be solved, but sources of creative energy. They are the engine of the system’s evolution. By naming them, you can begin to work with them.

5.  **Sense the Vitality:** Where is the system alive? Where is it stuck? Where is there energy and enthusiasm? Where is there apathy and decay? Use your intuition, your felt sense of the situation. This is a qualitative assessment, but it is just as important as any quantitative data. Look for the green shoots of new life, the places where the system is already trying to heal itself.
