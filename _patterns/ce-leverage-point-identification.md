...
id: pat_019c8c2122167e42bf5dbfd565
slug: ce-leverage-point-identification
title: "Leverage Point Identification"
aliases: ["Finding Leverage", "System Intervention Points", "Acupuncture for Systems"]
summary: >-
...
context_labels:
  corporate: "Identifying key process improvements for exponential efficiency gains."
  government: "Pinpointing policy changes that unlock widespread social benefit."
  activist: "Focusing campaigns on the critical nodes of power to shift a system."
  tech: "Optimizing a single algorithm or data structure that dramatically improves overall performance."
  community: "Nurturing a small group of connectors who can weave the entire network together."

# GROUP 3: ONTOLOGY & SEARCH
ontology:
  domain: life
  cross_domains: ["strategy", "systems-thinking", "governance"]
  specification_layer: L1
  search_hints:
    primary_tension: "Symptom-level action vs. Root-cause intervention"
    vector_keywords: ["systems thinking", "leverage points", "Donella Meadows", "intervention", "feedback loops", "system dynamics", "acupuncture"]
  commons_assessment:
    ...
    vitality: 4.5
    vitality_reasoning: >-
      This pattern is the essence of vitality. It's about finding the pulse of a system and applying just the right touch to enhance its life force. A system that understands its own leverage points can self-correct and evolve with minimal energy, which is a primary indicator of high vitality.
    overall_score: 3.8
...
relationships:
  ...
  specializes_to: []
  enables:
    - {id: lighthouse-initiation, weight: 0.8, description: "By identifying a key leverage point, you can design a small, high-impact 'lighthouse' project that demonstrates a new way of operating."}
    - {id: value-capture-ethics, weight: 0.6, description: "Understanding where leverage exists forces a conversation about who captures the value unlocked by the intervention."}
    - {id: generative-exit, weight: 0.5, description: "A successful intervention at a leverage point can make the original structure obsolete, creating the conditions for a generative exit."}
  requires:
    - {id: systems-seeing, weight: 0.9, description: "You cannot find leverage points without first being able to see the system as a whole, with its interconnected parts and feedback loops."}
    - {id: context-diagnosis, weight: 0.7, description: "Diagnosing the context reveals the underlying structures and dynamics where leverage points are likely to be found."}
  alternatives: []
  complementary:
    - {id: mental-model-externalization, weight: 0.7, description: "Mapping out mental models of the system is a powerful way to collaboratively discover and debate potential leverage points."}
    - {id: purpose-articulation, weight: 0.6, description: "A clear sense of purpose acts as a compass, guiding the search for interventions that move the system toward its desired state."}
  tools: []

# GROUP 6: GRAPH GARDEN
graph_garden:
  last_pruned: 2026-02-23
  entities: ["Donella Meadows", "System Dynamics", "feedback loops", "policy change", "organizational design", "acupuncture", "catalytic intervention"]
  communities: []
  inferred_links: []
