...
id: pat_019c8c2122167230b834e8c699
slug: offering-design
title: "Offering Design"
aliases: ["Scalable Offerings", "Productized Services", "Leveraged Expertise"]
summary: >-
...
context_labels:
  corporate: "Developing productized service offerings to scale consulting practices or internal expertise."
  government: "Creating standardized, replicable policy toolkits or program frameworks for broader implementation."
  activist: "Packaging campaign strategies or organizing models into distributable guides for decentralized movements."
  tech: "Designing APIs, SDKs, or developer kits that allow others to build on your platform at scale."
  community: "Creating 'community-in-a-box' kits or workshop formats that allow others to replicate a successful local initiative."

# GROUP 3: ONTOLOGY & SEARCH
ontology:
  domain: life
  cross_domains: [business, strategy, technology]
  specification_layer: L1
  search_hints:
    primary_tension: "Time-for-Money vs. Scalable Leverage"
    vector_keywords: [productization, scalability, leverage, service design, intellectual property, passive income, value creation]
  commons_assessment:
    ...
    vitality: 4.0
    vitality_reasoning: >-
      Vitality in Offering Design comes from its ability to decouple value creation from the creator's direct time. A vital offering is a living entity that others can interact with, adapt, and derive value from independently. Its health is measured by its adoption, its composability with other systems, and its capacity to evolve.
    overall_score: 3.5
...
relationships:
  ...
  specializes_to: []
  enables:
    - {id: knowledge-productization, weight: 0.8, description: "Provides the structure into which knowledge products are integrated and delivered."}
    - {id: intellectual-asset-design, weight: 0.7, description: "Defines the container and delivery mechanism for the intellectual assets created."}
    - {id: value-capture-ethics, weight: 0.5, description: "A well-designed offering clarifies the value exchange, making ethical capture more transparent."}
  requires:
    - {id: purpose-articulation, weight: 0.6, description: "The offering must be a clear expression of a core purpose to attract the right users."}
    - {id: mental-model-externalization, weight: 0.8, description: "The core logic of the offering is built upon externalized mental models."}
  alternatives: []
  complementary:
    - {id: reputation-compounding, weight: 0.7, description: "Successful offerings become powerful engines for compounding reputation at scale."}
    - {id: consistent-presence, weight: 0.5, description: "An offering serves as a constant, tangible presence in the market, representing your expertise."}
  tools: []

# GROUP 6: GRAPH GARDEN
graph_garden:
  last_pruned: 2026-02-23
  entities: ["Online Courses", "SaaS Products", "Consulting Frameworks", "Open Source Libraries", "Book Publishing", "Digital Templates", "API Services"]
  communities: []
  inferred_links: []
