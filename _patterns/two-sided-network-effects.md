---
id: pat_ddc4fc2fbda24b4181dda11d
title: Two-Sided Network Effects
slug: two-sided-network-effects
aliases: []
classification:
  universality: domain
  domain: startup
...
page_url: https://commons-os.github.io/patterns/two-sided-network-effects/
github_url: https://github.com/Commons-OS/patterns/blob/main/_patterns/two-sided-network-effects.md
created: 2026-02-01
modified: 2026-02-01
contributors:
- name: Commons OS
...
1.  [Two-sided market - Wikipedia](https://en.wikipedia.org/wiki/Two-sided_market)
2.  [Two-Sided Marketplaces and Engagement - Sequoia Capital](https://articles.sequoiacap.com/two-sided-marketplaces-and-engagement)
3.  [Strategies for Two-Sided Markets - Harvard Business Review](https://hbr.org/2006/10/strategies-for-two-sided-markets)
4. [The Network Effects Manual: 16 Different Network Effects (and counting) - NFX](https://www.nfx.com/post/network-effects-manual)
5. [What Are Network Effects? - Harvard Business School Online](https://online.hbs.edu/blog/post/what-are-network-effects)
