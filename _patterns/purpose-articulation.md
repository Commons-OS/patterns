...
# ═══════════════════════════════════════════════════════════════════
id: pat_019c8c2122167596b4202003a9
slug: purpose-articulation
title: "Purpose Articulation"
aliases: ["Mission Clarity", "Personal Why Statement", "Core Intent Declaration"]
summary: >-
...
# ═══════════════════════════════════════════════════════════════════
context_labels:
  corporate: "Mission Statement & Strategic Intent"
  government: "Public Mandate Articulation"
  activist: "Movement Purpose Declaration"
  tech: "Product Vision & North Star Metric"
  community: "Community Charter & Shared Intent"
...
ontology:
  ...
  search_hints:
    primary_tension: "Diffuse Capability vs. Focused Intent"
    vector_keywords: [purpose, mission, vision, alignment, focus, identity, motivation]
  commons_assessment:
    ...
    vitality: 4.6
    vitality_reasoning: >-
      A clearly articulated purpose acts as the generative seed of a living system. It breathes coherence into every subsequent decision, attracting aligned energy and repelling entropy. Without it, even the most capable practitioner drifts into reactive busyness. The score reflects its foundational role in enabling self-organization and adaptive capacity.
    overall_score: 4.1
...
relationships:
  ...
  specializes_to: []
  enables:
    - {id: context-diagnosis, weight: 0.8, description: "A clear purpose provides the lens through which context becomes legible."}
    - {id: offering-design, weight: 0.7, description: "Purpose defines what you offer and to whom — it is the seed of every offering."}
    - {id: ce-learning-in-public, weight: 0.6, description: "Knowing your purpose gives you the confidence to share your thinking openly."}
  requires:
    - {id: systems-seeing, weight: 0.7, description: "Seeing the whole system helps you find where your purpose has the most leverage."}
  alternatives: []
  complementary:
    - {id: engineering-attitude, weight: 0.6, description: "The engineering attitude provides the discipline to test and refine your purpose against reality."}
    - {id: narrative-courage, weight: 0.7, description: "Articulating purpose requires the courage to declare what you stand for."}
  tools: []
...
graph_garden:
  ...
  entities: ["Simon Sinek", "Viktor Frankl", "Ikigai", "North Star", "Value Proposition", "Personal Mission Statement"]
  communities: []
  inferred_links: []
