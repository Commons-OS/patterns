...
id: pat_019c8c2122167e3d91c26d8b0c
slug: living-system-design
title: "Living System Design"
aliases: ["Generative Design", "Resilient Systems", "Adaptive Architecture"]
summary: >-
  The integrative practice of designing systems that are adaptive, resilient, and generative — systems that breathe.

# GROUP 2: CONTEXTUAL TRANSLATION
context_labels:
  corporate: "Designing organizations as adaptive ecosystems rather than rigid hierarchies, fostering innovation and resilience."
  government: "Shifting from top-down policy imposition to creating enabling environments for civic engagement and social innovation."
  activist: "Building movements that are decentralized, resilient, and capable of adapting to changing political landscapes."
  tech: "Developing platforms and protocols that enable emergent, user-driven value creation and governance."
  community: "Cultivating local networks and initiatives that are self-organizing, sustainable, and responsive to member needs."

# GROUP 3: ONTOLOGY & SEARCH
ontology:
  domain: meta
  cross_domains: [strategy, technology, community, governance]
  specification_layer: L1
  search_hints:
    primary_tension: "Mechanistic Control vs. Emergent Life"
    vector_keywords: [regenerative, autopoiesis, complexity, emergence, stewardship, whole systems, generativity]
  commons_assessment:
    ...
    vitality: 5.0
    vitality_reasoning: >-
      Living System Design is the pinnacle of vitality. It is the practice of creating the conditions for vitality itself, designing for emergence, adaptation, and regeneration. A system designed with these principles is inherently alive.
    overall_score: 4.7
...
relationships:
  ...
  specializes_to: []
  enables:
    - {id: commons-as-practice, weight: 0.8, description: "Provides the 'how' for implementing commons structures as ongoing, adaptive processes."}
    - {id: blueprint-application, weight: 0.7, description: "Translates abstract blueprints into context-specific, living implementations."}
    - {id: generative-exit, weight: 0.6, description: "Creates systems so resilient and autonomous they can thrive beyond their founder's involvement."}
  requires:
    - {id: systems-seeing, weight: 0.9, description: "The ability to perceive the interconnectedness and dynamism of a system is foundational."}
    - {id: vitality-diagnosis, weight: 0.8, description: "Requires the ability to sense and interpret the signs of life and decay within a system."}
  alternatives: []
  complementary:
    - {id: stewardship-rotation, weight: 0.5, description: "Introduces a mechanism for ensuring long-term vitality and preventing stagnation."}
    - {id: collective-sensing, weight: 0.6, description: "Provides the feedback loops necessary for a living system to learn and adapt."}
  tools: []

# GROUP 6: GRAPH GARDEN
graph_garden:
  last_pruned: 2026-02-23
  entities: ["Permaculture", "Platform Cooperatives", "Haier's Rendanheyi model", "Cybernetics", "Biomimicry", "Sociocracy 3.0", "The Ethereum Ecosystem"]
  communities: []
  inferred_links: []
