...
id: pat_019c8c212216781d8680ab747d
slug: mental-model-externalization
title: "Mental Model Externalization"
aliases: ["Insight Translation", "Visible Thinking", "Concept Mapping"]
summary: >-
...
context_labels:
  ...
  activist: "Theory of Change"
  tech: "System Architecture"
  community: "Shared Understanding"

# GROUP 3: ONTOLOGY & SEARCH
ontology:
  domain: life
  cross_domains: [strategy, technology, education]
  specification_layer: L1
  search_hints:
    primary_tension: "Private Insight vs. Public Tool"
    vector_keywords: ["mental model", "visualization", "systems thinking", "knowledge sharing", "collaboration", "diagramming", "mapping"]
  commons_assessment:
    ...
    vitality: 3.5
    vitality_reasoning: >-
      This pattern has high vitality as it directly addresses the core challenge of making tacit knowledge explicit, a foundational move for any collaborative endeavor. Its vitality is tempered only by the skill and willingness of the practitioner to actually engage in the vulnerability of sharing their internal world.
    overall_score: 3.2
...
relationships:
  ...
  enables:
    - id: context-diagnosis
      weight: 0.7
      description: "Externalized models provide the canvas for diagnosing a system's context."
    - id: knowledge-productization
      weight: 0.6
      description: "Visible models are the first step toward creating valuable knowledge products."
    - id: collaborative-governance
      weight: 0.5
      description: "Shared models are essential for negotiating and establishing governance."
  requires:
    - id: systems-seeing
      weight: 0.8
      description: "You must first be able to see the system before you can map it."
    - id: engineering-attitude
      weight: 0.5
      description: "An engineering attitude provides the rigor to create useful, testable models."
  alternatives: []
  complementary:
    - id: ce-learning-in-public
      weight: 0.6
      description: "Sharing your models is a powerful way to learn in public."
    - id: body-of-work-cultivation
      weight: 0.5
      description: "A collection of externalized models forms a significant part of one's body of work."
  tools: []

# GROUP 6: GRAPH GARDEN
graph_garden:
  last_pruned: 2026-02-23
  entities: ["Concept Map", "System Diagram", "User Journey", "Theory of Change", "Wardley Map", "Causal Loop Diagram"]
  communities: []
  inferred_links: []
