---
id: pat_48dfee4f0f3b4ffeb702edaa
title: "No Brilliant Jerks"
slug: no-brilliant-jerks
aliases: []
classification:
  universality: domain
  domain: startup
...
page_url: "https://commons-os.github.io/patterns/no-brilliant-jerks/"
github_url: "https://github.com/Commons-OS/patterns/blob/main/_patterns/no-brilliant-jerks.md"
created: 2026-02-01
modified: 2026-02-01
...
1.  **Psychological Safety is Paramount:** The primary principle is the creation of a work environment where all employees feel safe to express their ideas, ask questions, and make mistakes without fear of humiliation or retribution. This is the foundation for innovation and effective collaboration.

2.  **Team Performance Over Individual Stardom:** The success of the team and the organization as a whole is valued more highly than the individual achievements of any single employee. The pattern recognizes that a cohesive, high-performing team will always outperform a dysfunctional group of brilliant individuals in the long run.

3.  **Long-Term Cultural Health Trumps Short-Term Gains:** Tolerating a brilliant jerk may lead to short-term wins, but it will inevitably erode the company's culture over time. This pattern prioritizes the long-term health and sustainability of the organization's culture.

4.  **Behavioral Standards are Universal:** The rules of conduct apply to everyone in the organization, regardless of their performance or seniority. There are no special exceptions for high-performers. This consistency is crucial for building trust and a sense of fairness.

5.  **Shared Responsibility for Cultural Stewardship:** It is everyone's responsibility, from the CEO to the newest hire, to uphold and protect the company's culture. This includes calling out and addressing behavior that is inconsistent with the organization's values.

6.  **Redemption is Possible, but Not Guaranteed:** The goal is not to be punitive, but to foster a better work environment. Individuals who exhibit jerk-like behavior should be given clear, direct feedback and an opportunity to change. However, if they are unwilling or unable to adapt, the organization must be prepared to let them go.

### 3. Key Practices

1.  **Codify and Communicate the Policy:** Formally document the "No Brilliant Jerks" policy in your company's values, culture deck, and employee handbook. Communicate it clearly and frequently to all employees.

2.  **Hire for Culture Fit:** During the hiring process, explicitly screen for self-awareness, empathy, and a collaborative mindset. Use behavioral interview questions to assess how candidates have handled conflict and worked in team environments in the past.

3.  **Implement 360-Degree Feedback:** Utilize a 360-degree feedback system where employees receive feedback from their peers, direct reports, and managers. This can help to identify and address jerk-like behavior that may not be visible to leadership.

4.  **Provide Radical Candor:** When problematic behavior is identified, provide immediate, direct, and constructive feedback. Clearly explain the impact of their behavior on others and the team, and set clear expectations for improvement.

5.  **Coach, Don't Just Criticize:** Offer coaching and support to help employees who are struggling with their interpersonal skills. This could include providing access to a professional coach, a mentor, or training programs.

6.  **The Keeper Test:** Netflix famously uses the "Keeper Test": if a person on your team were to quit tomorrow, would you try to change their mind? Or would you accept their resignation, perhaps with a little relief? If the latter, you should probably let them go now.

7.  **Reward Collaboration and Teamwork:** Ensure that your performance management and compensation systems reward not just individual contributions, but also collaboration, mentorship, and other behaviors that contribute to a healthy team environment.

8.  **Leaders Must Model the Way:** The most important practice is for leaders to consistently model the behavior they expect from others. If leaders tolerate or exhibit jerk-like behavior, the policy will be seen as hypocritical and will ultimately fail.
...
1.  [Gregg, B. (2017, November 13). Brilliant Jerks in Engineering. Brendan Gregg's Blog.](https://www.brendangregg.com/blog/2017-11-13/brilliant-jerks.html)
2.  [Berkun, S. (2017, June 22). Netflix’s updated guide to culture – an analysis & commentary. Scott Berkun.](https://scottberkun.com/2017/netflixs-updated-guide-to-culture-an-analysis-commentary/)
3.  [Sutton, R. I. (2007). The No Asshole Rule: Building a Civilized Workplace and Surviving One That Isn't. Business Plus.](https://www.amazon.com/Asshole-Rule-Civilized-Workplace-Surviving/dp/0446526568)
4.  [Hastings, R. & Meyer, E. (2020). No Rules Rules: Netflix and the Culture of Reinvention. Penguin Press.](https://www.amazon.com/No-Rules-Netflix-Culture-Reinvention/dp/1984877860)
5.  [Schleckser, J. (2016, February 2). Why Netflix Doesn't Tolerate Brilliant Jerks. Inc. Magazine.](https://www.inc.com/jim-schleckser/why-netflix-doesn-t-tolerate-brilliant-jerks.html)
