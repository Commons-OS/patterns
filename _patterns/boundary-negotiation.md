...
id: pat_019c8c21221671fb840cd7a30d
slug: boundary-negotiation
title: "Boundary Negotiation"
aliases: ["Defining Interfaces", "Sovereignty in Collaboration", "Partnership Architecture"]
summary: >-
...
context_labels:
  corporate: "Defining Service-Level Agreements (SLAs) and team charters."
  government: "Negotiating treaties and inter-agency jurisdictions."
  activist: "Establishing roles and responsibilities within a coalition."
  tech: "Specifying API contracts and data ownership."
  community: "Setting membership expectations and community guidelines."

# GROUP 3: ONTOLOGY & SEARCH
ontology:
  domain: life
  cross_domains: ["business", "governance", "community"]
  specification_layer: L1
  search_hints:
    primary_tension: "Shared Purpose vs. Individual Autonomy"
    vector_keywords: ["collaboration", "sovereignty", "interfaces", "agreements", "partnerships", "boundaries", "governance"]
  commons_assessment:
    ...
    vitality: 4.0
    vitality_reasoning: >-
      This pattern is critical for the health of any collaborative system. Clear boundaries prevent conflict, reduce friction, and enable trust, which are all signs of a vital, living system. Without it, collaborations tend toward entropy and decay.
    overall_score: 4.1
...
relationships:
  ...
  enables:
    - id: collaborative-governance
      weight: 0.8
      description: "Clear boundaries are the prerequisite for effective collaborative governance."
    - id: complementary-capability-matching
      weight: 0.6
      description: "Knowing where one entity ends and another begins allows for precise capability matching."
    - id: community-of-practice-design
      weight: 0.5
      description: "Defines the scope and expectations for participation in a community of practice."
  requires:
    - id: purpose-articulation
      weight: 0.9
      description: "A shared purpose is the gravitational center around which boundaries are negotiated."
    - id: context-diagnosis
      weight: 0.7
      description: "Understanding the environment is essential to defining relevant and resilient boundaries."
  alternatives: []
  complementary:
    - id: conflict-as-signal
      weight: 0.7
      description: "Boundary transgressions become useful signals for adaptation rather than sources of destructive conflict."
    - id: reciprocity-design
      weight: 0.6
      description: "Negotiated boundaries clarify the surfaces upon which reciprocal exchange can occur."
  tools: []

# GROUP 6: GRAPH GARDEN
graph_garden:
  last_pruned: 2026-02-23
  entities: ["Marriage Vows", "API Contracts", "Team Charters", "Treaties", "Service-Level Agreements (SLAs)", "Community Guidelines"]
  communities: []
  inferred_links: []
