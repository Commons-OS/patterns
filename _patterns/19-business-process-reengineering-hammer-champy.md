---
id: pat_01kg50240sfm8re6enywbq3x5s
page_url: https://commons-os.github.io/patterns/19-business-process-reengineering-hammer-champy/
github_url: https://github.com/commons-os/patterns/blob/main/_patterns/19-business-process-reengineering-hammer-champy.md
slug: 19-business-process-reengineering-hammer-champy
title: Business Process Reengineering - Hammer & Champy
aliases: [BPR, Business Process Redesign, Business Transformation]
version: 1.0
...
sources: [https://en.wikipedia.org/wiki/Business_process_re-engineering, https://www.ibm.com/think/topics/business-process-reengineering, https://www.forbes.com/sites/forbestechcouncil/2022/09/19/the-resurgence-of-business-process-reengineering-in-the-digital-age/, https://hbr.org/1990/07/reengineering-work-dont-automate-obliterate, https://www.bain.com/insights/business-process-reengineering/]
...
1.  **Stakeholder Mapping**: BPR, in its traditional form, primarily focuses on the stakeholders who are directly involved in the process being reengineered. This typically includes employees, customers, and suppliers. However, it often overlooks the broader ecosystem of stakeholders, such as the community, the environment, and future generations. A more commons-aligned approach to BPR would involve a more comprehensive stakeholder mapping process that considers the needs and interests of all affected parties.
2.  **Value Creation**: BPR is highly effective at creating value for the organization and its customers. By streamlining processes and eliminating waste, BPR can lead to significant improvements in efficiency, quality, and speed. However, the value created by BPR is often narrowly defined in financial terms. A more commons-aligned approach would consider a broader range of value, including social, environmental, and cultural value.
3.  **Value Preservation**: BPR is focused on achieving dramatic, one-time improvements in performance. It is not designed to be a continuous improvement methodology. As a result, the value created by BPR can erode over time as the business environment changes. A more commons-aligned approach would incorporate principles of continuous improvement and adaptation to ensure that the value created by BPR is preserved and enhanced over time.
4.  **Shared Rights & Responsibilities**: BPR is typically a top-down initiative that is driven by management. Employees are often seen as objects to be reengineered, rather than as active participants in the process. A more commons-aligned approach would involve a more participatory and collaborative approach to BPR, where employees are empowered to co-design the new processes and to share in the benefits of the improvements.
5.  **Systematic Design**: BPR is a systematic approach to process redesign. It involves a structured methodology for analyzing existing processes, identifying areas for improvement, and designing new processes. However, the design of BPR itself is often not systematic. It is often a one-off project that is not integrated into the organization's overall management system. A more commons-aligned approach would involve a more systematic approach to BPR, where it is integrated into the organization's overall management system and is used as a tool for continuous improvement.
6.  **Systems of Systems**: BPR is often focused on optimizing individual processes in isolation. It does not always consider the impact of process changes on other parts of the organization or on the broader ecosystem. A more commons-aligned approach would take a more holistic, systems-of-systems view of BPR, considering the interdependencies between different processes and the impact of process changes on the entire system.
7.  **Fractal Properties**: The principles of BPR can be applied at different scales, from a single team to an entire organization. However, the implementation of BPR is often not fractal. It is often a large-scale, monolithic project that is difficult to adapt to different contexts. A more commons-aligned approach would involve a more fractal and modular approach to BPR, where the principles can be applied in a flexible and scalable way.

Overall, BPR receives a Commons Alignment Score of 3 (Transitional). While it has the potential to be a powerful tool for creating a more commons-aligned economy, its traditional application often leans towards being extractive and exploitative. To elevate BPR towards a more commons-aligned approach, it is imperative to embrace a more holistic, participatory, and systemic perspective on process redesign. This involves expanding the scope of stakeholder consideration, broadening the definition of value, incorporating principles of continuous improvement, fostering a more collaborative approach, and taking a more integrated, systems-of-systems view.
...
- **Page URL**: [https://commons-os.github.io/patterns/implementation/19-business-process-reengineering-hammer-champy/](https://commons-os.github.io/patterns/implementation/19-business-process-reengineering-hammer-champy/)
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_patterns/19-business-process-reengineering-hammer-champy.md)
- **Edit**: [Edit this pattern](https://github.com/commons-os/patterns/edit/main/_implementation/19-business-process-reengineering-hammer-champy.md)
