...
# ═══════════════════════════════════════════════════════════════════
id: pat_01khvcxcyjetybhszn7fpp0v3z
slug: obituary-writing-practice
title: "Obituary Writing Practice"
aliases: []
summary: >-
  Write your own obituary or imagined version as reflection on what
  matters, how you want to be remembered, and what legacy you want to
  create.
...
# ═══════════════════════════════════════════════════════════════════
context_labels:
  corporate: "Write version of your obituary; notice what you include and what you emphasize; reflect on alignment with actual priorities."
  government: "Revisit and update regularly; notice how your understanding of what matters changes over time."
  activist: "Use obituary writing to clarify values and ensure you're allocating time and energy to what truly matters."
  tech: "Remember that obituary can reflect multiple sides of life: work, relationships, community, creative contributions."
...
ontology:
  ...
  commons_domain:
    - life
  search_hints:
    primary_tension: "Obituary vs. Practice"
    vector_keywords: ["obituary", "writing", "practice", "write", "imagined"]
  commons_assessment:
    ...
    vitality_reasoning: >-
      ...
      system's existing health. 'Obituary Writing Practice' contributes
...
relationships:
  ...
  complementary:
    - slug: absurdism-and-joy
      weight: 0.85
    - slug: absurdist-perspectives-on-existential-challenges
      weight: 0.8
...
graph_garden:
  ...
  entities:
    ...
    - id: self-narrative
      ...
      relevance: 0.85
    - id: existential-inquiry
      type: practice
      label: "Existential Inquiry"
      relevance: 0.83
  ...
  communities:
    - id: life-design
      label: "Life Design & Life Planning"
      source: inferred
      confidence: 0.92
    - id: existential-philosophy
      label: "Existential Philosophy & Meaning"
      source: inferred
      confidence: 0.88
    - id: personal-development
      label: "Personal Development & Self-Knowledge"
      source: inferred
      confidence: 0.85
    - id: aging-and-mortality
      label: "Aging, Mortality & Life Transitions"
      source: inferred
      confidence: 0.82
  inferred_links:
    - target: advance-directive-design
      type: complementary
      confidence: 0.9
      reason: "Both clarify values and document personal wishes for end-of-life"
    - target: absurdism-and-joy
      type: complementary
      confidence: 0.85
      reason: "Both grapple with meaning despite mortality and finite existence"
    - target: aging-and-creative-peak
      type: complementary
      confidence: 0.83
      reason: "Reflection on legacy connects to creative maturation in later life"
    - target: acceptance-and-commitment
      type: complementary
      confidence: 0.82
      reason: "Both involve clarifying values and committing to meaningful action"
    - target: active-imagination-technique
      type: complementary
      confidence: 0.78
      reason: "Imagining future self aligns with active imagination practice"
    - target: absurdist-perspectives-on-existential-challenges
      type: complementary
      confidence: 0.8
      reason: "Both engage with existential themes and life's deeper meaning"
    - target: acting-despite-irreducible-uncertainty
      type: complementary
      confidence: 0.76
      reason: "Obituary writing commits to values despite unknowable future"
    - target: achievement-celebration
      type: complementary
      confidence: 0.74
      reason: "Recognizing legacy involves acknowledging meaningful achievements"
    - target: aesthetic-coherence-in-personal-brand
      type: complementary
      confidence: 0.72
      reason: "Both involve intentional self-presentation and personal coherence"
    - target: aging-and-sexuality
      type: complementary
      confidence: 0.71
      reason: "Legacy work often accompanies reflection on aging and life stages"
# ═══════════════════════════════════════════════════════════════════
# GROUP 7: PROVENANCE
# ═══════════════════════════════════════════════════════════════════
...
> This pattern draws on Legacy, values clarification, mortality awareness, life purpose.
