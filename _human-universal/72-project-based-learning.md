---
id: pat_01kg5023veffgvjftvw4v9njvv
page_url: https://commons-os.github.io/patterns/human-universal/72-project-based-learning/
github_url: https://github.com/commons-os/patterns/blob/main/_human-universal/72-project-based-learning.md
slug: 72-project-based-learning
title: Project-Based Learning
aliases: [PBL, Project-Based Instruction]
version: 1.0
...
sources: [https://www.pblworks.org/what-is-pbl, https://www.edutopia.org/project-based-learning, https://www.pblworks.org/what-is-pbl/gold-standard-project-design, https://www.pblworks.org/blog/gold-standard-pbl-project-based-teaching-practices, https://www.lucasedresearch.org/docs/the-evidence-is-clear-rigorous-project-based-learning-is-an-effective-lever-for-student-success/, https://www.edutopia.org/article/new-study-shows-impact-pbl-student-achievement-nell-duke-anne-lise-halvorsen/]
...
**Scale**:
Project-Based Learning is a fractal pattern that can be applied across multiple scales:
...
**Domains**:
While it originated in education, Project-Based Learning is widely applied in various domains:
...
**References**:
[1] Lucas Education Research. (2021). *The Evidence Is Clear: Rigorous Project-Based Learning is an Effective Lever for Student Success*. https://www.lucasedresearch.org/docs/the-evidence-is-clear-rigorous-project-based-learning-is-an-effective-lever-for-student-success/
[2] Duke, N. K., & Halvorsen, A. (2017). *New Study Shows the Impact of PBL on Student Achievement*. Edutopia. https://www.edutopia.org/article/new-study-shows-impact-pbl-student-achievement-nell-duke-anne-lise-halvorsen/
[3] Almulla, M. A. (2020). The Effectiveness of the Project-Based Learning (PBL) Approach as a Way to Engage Students in Learning. *SAGE Open*, *10*(3). https://doi.org/10.1177/2158244020938702
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_human-universal/72-project-based-learning.md)
