---
id: pat_01kg50240sfm8re6epa0wyd5k3
page_url: https://commons-os.github.io/patterns/implementation/52-value-proposition-canvas-osterwalder/
github_url: https://github.com/commons-os/patterns/blob/main/_implementation/52-value-proposition-canvas-osterwalder.md
slug: 52-value-proposition-canvas-osterwalder
...
tags:
  ...
  status: draft
  commons_alignment: 3
generalizes_from: ["pat_01kg50240afth9zmxppx883fhh"]
specializes_to: []
enables: []
requires: []
related: []
...
1.  **Focus on the Customer**: The fundamental principle of the Value Proposition Canvas is its unwavering focus on the customer. It forces teams to step outside of their own perspective and to deeply empathize with the customer's world, their jobs-to-be-done, their pains, and their gains. This principle ensures that value creation is driven by genuine customer needs, not by internal assumptions or technological possibilities alone.

2.  **Achieve Problem-Solution Fit**: The canvas is explicitly designed to help teams find what is known as "problem-solution fit." This means ensuring that the proposed product or service (the value proposition) directly addresses the customer's most significant pains and creates the most relevant gains. It's about creating a direct and compelling connection between what the customer needs and what the business offers.
...
1.  **Assemble the Team and Gather Materials**: Get the right people in a room with a large printout of the Value Proposition Canvas, sticky notes, and markers.
2.  **Start with the Customer Profile**: Begin by brainstorming the customer's jobs, pains, and gains. Encourage everyone to contribute their ideas and to think from the customer's perspective.
3.  **Map the Value Proposition**: Once the customer profile is complete, move on to the value map. Brainstorm the products and services, pain relievers, and gain creators.
4.  **Connect the Dots (Find Fit)**: Draw lines between the pain relievers and the pains they address, and between the gain creators and the gains they produce. This will help to visualize the fit between the value proposition and the customer profile.
5.  **Identify and Prioritize Assumptions**: As a team, identify the most critical assumptions underlying the canvas. These are the things that must be true for the value proposition to succeed.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_implementation/52-value-proposition-canvas-osterwalder.md)
