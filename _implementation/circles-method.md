---
id: pat_01kg50240vft1bjmxt1n6xb6js
page_url: https://commons-os.github.io/patterns/implementation/circles-method/
github_url: https://github.com/commons-os/patterns/blob/main/_implementation/circles-method.md
slug: circles-method
...
Start by asking clarifying questions to understand the context. For example:
...
Next, identify the potential user segments for a smart bed. These could include:
...
Now, articulate the needs of the Health-Conscious Professional in the form of user stories:
...
Prioritize these needs based on their importance to the user. For the Health-Conscious Professional, tracking sleep quality and waking up refreshed are likely the most critical needs.

**5. List Solutions:**
Brainstorm potential solutions to address these prioritized needs:
...
Finally, summarize your recommendation. For example:
“My recommendation is to design a smart bed that focuses on the core needs of the Health-Conscious Professional. The initial product would include integrated sleep tracking and a smart alarm feature. This combination provides a strong value proposition by helping users to both understand and improve their sleep. In the future, we could expand the product to include personalized sleep coaching and climate control as premium features.”
...
[2] [Product School. “A Guide to the CIRCLES Framework with Product Examples.”](https://productschool.com/blog/skills/circles-framework-guide)

[3] [Impact Interview. “Intro to the CIRCLES Method™ Product Design Framework.”](https://www.impactinterview.com/2016/06/circles-method-product-design-framework/)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_implementation/circles-method.md)
