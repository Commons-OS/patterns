---
id: pat_01kg502410ekgvrq2tx6wz36nr
page_url: https://commons-os.github.io/patterns/implementation/x-matrix-hoshin-kanri-tool/
github_url: https://github.com/commons-os/patterns/blob/main/_implementation/x-matrix-hoshin-kanri-tool.md
slug: x-matrix-hoshin-kanri-tool
title: X-Matrix - Hoshin Kanri Tool
aliases: []
version: 1.0
...
generalizes_from: ["pat_01kg5023w5f1985waqkyypbjpj"]
specializes_to: []
enables: []
requires: []
related: []
...
1.  [Learn All About Hoshin Kanri X Matrix: Full Guide](https://businessmap.io/lean-management/hoshin-kanri/what-is-hoshin-kanri-x-matrix)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_implementation/x-matrix-hoshin-kanri-tool.md)
