---
id: pat_01kg50240xe19r5fzr1849rxsr
page_url: https://commons-os.github.io/patterns/implementation/phase-gate-process/
github_url: https://github.com/commons-os/patterns/blob/main/_implementation/phase-gate-process.md
slug: phase-gate-process
title: Phase-Gate Process
aliases: []
version: 1.0
...
The Commons Alignment Assessment evaluates how well the Phase-Gate process aligns with the principles of a commons-based approach. The assessment is based on seven dimensions, each rated on a scale of 1 to 5, where 1 indicates low alignment and 5 indicates high alignment. The overall commons alignment score for the Phase-Gate process is 3, reflecting a mixed but generally positive alignment with commons principles.

| Dimension | Rating | Assessment |
| :--- | :--- | :--- |
| **Openness & Transparency** | 4 | The Phase-Gate process promotes transparency by making the decision-making process and criteria explicit. The clear definition of phases, gates, and deliverables ensures that all stakeholders have a shared understanding of the project's status and direction. However, the process can be implemented in a closed and proprietary manner, limiting its openness. |
| **Decentralization & Federation** | 2 | The Phase-Gate process is often implemented in a centralized manner, with a small group of senior managers acting as gatekeepers. This can create a bottleneck and limit the autonomy of the project team. However, the process can be adapted to be more decentralized, with distributed decision-making and more autonomy for the project team. |
| **Community & Collaboration** | 4 | The process explicitly encourages cross-functional collaboration, bringing together individuals from different parts of the organization to work towards a common goal. This can help to break down silos and foster a sense of community. The emphasis on shared ownership and collective responsibility is well-aligned with commons principles. |
| **Sustainability & Resilience** | 3 | By killing unpromising projects early, the Phase-Gate process helps to ensure the sustainable use of resources. This focus on resource efficiency contributes to the long-term resilience of the organization. However, the process can also lead to a risk-averse culture that stifles the kind of experimentation and learning that is essential for long-term adaptation and resilience. |
| **Fairness & Equity** | 3 | The use of objective and transparent criteria for decision-making helps to ensure a degree of fairness and equity in the allocation of resources. However, the centralized nature of the process can also lead to power imbalances and a lack of voice for those who are not in positions of authority. |
| **Modularity & Reusability** | 4 | The Phase-Gate process is a modular and reusable framework that can be adapted to a wide range of different contexts. The division of a project into a series of discrete phases and gates makes it easy to customize the process to the specific needs of a project or organization. |
| **Purpose-driven & Value-generating** | 3 | The process is designed to ensure that projects are aligned with the strategic objectives of the organization and that they generate value for the business. However, the focus on financial metrics and business cases can sometimes overshadow other forms of value, such as social and environmental value. |
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_implementation/phase-gate-process.md)
