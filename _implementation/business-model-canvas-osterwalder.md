---
id: pat_01kg50240vft1bjmxszvc6mybj
page_url: https://commons-os.github.io/patterns/implementation/business-model-canvas-osterwalder/
github_url: https://github.com/commons-os/patterns/blob/main/_implementation/business-model-canvas-osterwalder.md
slug: business-model-canvas-osterwalder
...
*   **Integration with Other Tools**: The BMC works best when it is integrated with other tools and methodologies, such as the Value Proposition Canvas, Lean Startup, and Design Thinking.
_continued_
### 6. Evidence & Impact
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_implementation/business-model-canvas-osterwalder.md)
