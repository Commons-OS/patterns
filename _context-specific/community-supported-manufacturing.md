---
id: pat_01kg50240me98tfa0ytg0gvbt5
page_url: https://commons-os.github.io/patterns/context-specific/community-supported-manufacturing/
github_url: https://github.com/commons-os/patterns/blob/main/_context-specific/community-supported-manufacturing.md
slug: community-supported-manufacturing
title: Community Supported Manufacturing
aliases: []
version: 1.0
...
1.  **Build a Community:** The first step is to build a community of people who are interested in supporting the manufacturing of a particular product. This can be done through online forums, social media, and local events.

2.  **Develop a Proposal:** Once you have a community, you need to develop a proposal that outlines the product to be manufactured, the production process, the budget, and the timeline. This proposal should be developed in collaboration with the community to ensure that it meets their needs and expectations.

3.  **Raise Capital:** The next step is to raise the necessary capital for production. This can be done through pre-selling, crowdfunding, or other forms of community financing.

4.  **Set up Production:** Once you have the capital, you can set up the production facility and begin manufacturing the product. This may involve purchasing equipment, hiring staff, and developing a production workflow.

5.  **Distribute the Product:** The final step is to distribute the product to the community members who have supported the project. This can be done through a variety of channels, such as local pickups, shipping, or a community-run store.
...
*   [Community Supported Manufacturing on the P2P Foundation Wiki](https://wiki.p2pfoundation.net/Community_Supported_Manufacturing)
*   [Open Source Ecology's CEB Proposal](https://www.opensourceecology.org/ceb-proposal-community-supported-manufacturing/)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_context-specific/community-supported-manufacturing.md)
