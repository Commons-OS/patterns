---
id: pat_01kg5023w7f0htcqts1dpbnb1f
page_url: https://commons-os.github.io/patterns/domain/40-tows-matrix/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/40-tows-matrix.md
slug: 40-tows-matrix
title: TOWS Matrix
aliases: [TOWS Analysis]
version: 1.0
...
tags:
  ...
  commons_alignment: 3
generalizes_from: []
specializes_to: ["pat_01kg502406fvs8fk48h4ngbwxt"]
enables: []
requires: []
related: []
...
3.  **Four Strategic Perspectives:** The matrix generates four distinct strategic postures, each with a unique focus:
    ...
    *   **WT (Mini-Mini):** How can we minimize our weaknesses and avoid threats?
    This multi-faceted approach encourages a balanced and holistic view of strategy development.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/40-tows-matrix.md)
