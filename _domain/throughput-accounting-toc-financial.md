---
id: pat_01kg502406fvs8fk482858k8j7
page_url: https://commons-os.github.io/patterns/domain/throughput-accounting-toc-financial/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/throughput-accounting-toc-financial.md
slug: throughput-accounting-toc-financial
title: Throughput Accounting - TOC Financial
aliases: []
version: 1.0
...
tags:
  ...
  status: draft
  commons_alignment: 3
generalizes_from: ["pat_01kg5023wxeqsb7ey1eew1h0mw"]
specializes_to: []
enables: []
requires: []
related: []
...
1.  **Identify the System's Constraint(s):** The first step is to identify the part of the system that limits its ability to generate more Throughput. This could be a machine, a department, a policy, or even a market constraint.
2.  **Decide How to Exploit the System's Constraint(s):** Once the constraint is identified, the focus is on making the most of it. This means ensuring that the constraint is always working on the most profitable tasks and that its time is not wasted.
3.  **Subordinate Everything Else to the Above Decision:** All other parts of the system must be aligned to support the constraint. This may involve changing production schedules, inventory policies, and performance metrics to ensure that the constraint is never starved for work and that its output is not blocked.
4.  **Elevate the System's Constraint(s):** If the constraint still limits the system's performance after being fully exploited, the next step is to increase its capacity. This may involve investing in new equipment, hiring more staff, or improving the process.
5.  **If in the Previous Steps a Constraint Has Been Broken, Go Back to Step 1:** After a constraint has been elevated, a new constraint will emerge elsewhere in the system. The process then starts over again, creating a cycle of ongoing improvement.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/throughput-accounting-toc-financial.md)
