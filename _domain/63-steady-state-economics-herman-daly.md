---
id: pat_01kg5023wefm0801dqkdxfafby
page_url: https://commons-os.github.io/patterns/domain/63-steady-state-economics-herman-daly/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/63-steady-state-economics-herman-daly.md
slug: 63-steady-state-economics-herman-daly
...
sources: [https://en.wikipedia.org/wiki/Steady-state_economy, https://www.investopedia.com/terms/s/steady-state-economy.asp, https://steadystate.org/top-10-policies-for-a-steady-state-economy/]
...
The steady-state economy aligns strongly with commons principles by prioritizing long-term sustainability and equitable resource management over perpetual growth. It views the economy as a subsystem of the finite global ecosystem, a foundational concept of the commons.

1.  **Stakeholder Mapping**: The pattern is highly inclusive, recognizing the stake of all living beings, including future generations and other species, in the planet's health. This comprehensive stakeholder view is a key strength.

2.  **Value Creation**: It creates ecological value by preserving ecosystems, social value through equitable wealth distribution and community, and economic value via a stable, resilient system not dependent on growth. All of society, present and future, benefits.

3.  **Value Preservation**: The pattern is designed for long-term value preservation. By maintaining a constant stock of capital and population, and operating within ecological limits, it avoids the depletion of natural capital inherent in growth-oriented economies.

4.  **Shared Rights & Responsibilities**: It is based on shared rights to a healthy environment and shared responsibilities to protect it for future generations, reflected in policies like cap-auction-trade systems.

5.  **Systematic Design**: The pattern is a comprehensive framework, not a piecemeal approach. Its components (cap-auction-trade, ecological tax reform, limits on inequality) are designed to work together systematically.

6.  **Systems of Systems**: As a meta-pattern, it can be composed with other patterns like renewable energy, regenerative agriculture, and circular economy to create a more sustainable and resilient system.

7.  **Fractal Properties**: Its principles are fractal, applicable at all scales from local communities to the global level, enabling a nested system of sustainable economies.

**Overall Score**: 4/5 (Commons-Aligned)

The steady-state economy is a highly commons-aligned pattern. While challenges remain in its implementation, it offers a significant improvement over the current growth paradigm and a hopeful vision for a just and sustainable future. The score is not a perfect 5/5 because the pattern has not been fully implemented at a national scale, leaving many practical questions unanswered.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/63-steady-state-economics-herman-daly.md)
