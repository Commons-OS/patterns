---
id: pat_01kg5023x0ed9tvrqaye97r6y1
page_url: https://commons-os.github.io/patterns/domain/93-b-impact-assessment/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/93-b-impact-assessment.md
slug: 93-b-impact-assessment
...
tags:
  ...
  commons_alignment: 3
generalizes_from: []
specializes_to: ["pat_01kg5023xjea9ve0dqwkhevjfa"]
enables: []
requires: []
related: []
...
sources:
  ...
  - https://bcorporation.eu/become-a-b-corp/b-impact-assessment/
  - https://bcorporation.eu/resources/case-studies/
  - https://bcorporation.eu/case_study/zentek-b-corp-certification/
  - https://usca.bcorporation.net/zbtcz11z23zcase-studies-share-how-businesses-can-root-climate-action-in-justice/
...
*   **Credibility through Independent Governance:** The standards underpinning the B Impact Assessment are developed and overseen by the independent B Lab Standards Advisory Council, which is composed of experts from around the world with deep industry and stakeholder knowledge. This independent governance structure ensures that the assessment remains credible, objective, and responsive to emerging best practices and stakeholder feedback [2].

*   **Transparency and Accountability:** A core tenet of the B Corp movement is transparency. Companies that pursue B Corp Certification must make their B Impact Report, which includes their overall score and a summary of their performance in each impact area, publicly available on the B Lab website. This transparency fosters accountability and allows stakeholders to make informed decisions.

*   **Adaptability and Specificity:** The B Impact Assessment is not a one-size-fits-all tool. It dynamically adjusts the questions presented to a company based on its industry, size, and geographic location. This tailored approach ensures that the assessment is relevant and that the benchmarks provided are meaningful, allowing for fair comparisons between similar businesses.
...
*   **Comprehensive Impact Measurement:** The primary practice is the completion of the assessment itself. This involves a deep dive into a company's operational policies and practices, as well as its business model. The questions are designed to be educational, often introducing companies to new concepts and best practices in sustainability and social responsibility.

*   **Performance Benchmarking:** Upon completing the assessment, companies receive a B Impact Report that allows them to compare their performance to other businesses. This benchmarking is a powerful practice that provides context for a company's score and helps to identify areas where they are leading or lagging behind their peers.

*   **Identification of Impact Business Models (IBMs):** The BIA distinguishes between a company's operational impact and its "Impact Business Model." An IBM is a business model that is specifically designed to create a positive impact. The assessment identifies and awards additional points for these models, recognizing and encouraging businesses that have embedded purpose into their core value proposition.

*   **Goal Setting and Improvement Tracking:** The BIA platform includes features that allow companies to set specific, measurable, and time-bound improvement goals. This practice transforms the assessment from a static report into a dynamic management tool that can be used to drive and track progress over time.
...
The B Impact Assessment exhibits a moderate to strong alignment with the principles of a commons-based economy. While it operates within the existing market system, its fundamental purpose is to shift the behavior of businesses towards a more stakeholder-driven and commons-oriented approach. The assessment's alignment can be evaluated across several key dimensions of commons thinking.

**Stewardship of Shared Resources:** The BIA's Environment section directly addresses the stewardship of natural resources, which are a form of commons. It encourages companies to reduce their environmental footprint, conserve resources, and transition to a more circular model of production and consumption. By incentivizing these practices, the BIA promotes a sense of responsibility for the shared ecological commons.

**Community and Social Fabric:** The Community and Workers sections of the assessment are strongly aligned with the commons principle of nurturing the social fabric. The BIA encourages companies to be active and positive contributors to their local communities, to provide high-quality jobs with fair wages and benefits, and to foster a diverse and inclusive workplace. These practices help to build social capital and to strengthen the social commons.

**Knowledge and Information as a Commons:** The B Impact Assessment itself can be viewed as a form of knowledge commons. It is a freely available tool that encapsulates a vast body of knowledge about best practices in social and environmental performance. By making this knowledge accessible to all businesses, B Lab is contributing to a shared resource that can be used to drive positive change across the economy. The transparency requirement for B Corps, which involves publicly sharing their B Impact Reports, further contributes to this knowledge commons.

**Governance and Participation:** The Governance section of the BIA promotes principles of transparency, accountability, and stakeholder engagement, which are central to commons governance. It encourages companies to adopt legal structures that lock in their commitment to purpose and to create formal mechanisms for considering the interests of all stakeholders in their decision-making. However, the BIA does not explicitly advocate for commons-based governance models such as cooperatives or multi-stakeholder ownership structures, which represents a potential area for stronger alignment.

**Challenges and Limitations:** Despite its strong alignment in many areas, the B Impact Assessment still operates within the framework of a capitalist market economy. It seeks to reform the behavior of individual firms rather than to fundamentally transform the underlying economic system. The BIA's focus on individual company performance can sometimes obscure the systemic nature of many social and environmental problems. Furthermore, while the BIA encourages stakeholder engagement, it does not mandate the deep forms of co-creation and co-governance that are characteristic of many commons-based enterprises.

In conclusion, the B Impact Assessment is a powerful tool for advancing commons-oriented principles within the existing economic paradigm. It promotes a shift in corporate consciousness towards a greater sense of responsibility for shared social and environmental resources. While there are opportunities for deeper alignment, particularly in the areas of governance and systemic change, the BIA represents a significant and positive step towards a more just, equitable, and sustainable economy.

### 9. Resources & References

The following resources provide further information about the B Impact Assessment and the B Corp movement.

*   **B Lab Global Website:** The official website of B Lab provides a wealth of information about the B Impact Assessment, B Corp Certification, and the global movement to use business as a force for good. [https://www.bcorporation.net](https://www.bcorporation.net)

*   **B Impact Assessment Platform:** This is the portal where companies can register to take the B Impact Assessment. [https://app.bimpactassessment.net](https://app.bimpactassessment.net)

*   **B Lab Europe Website:** The regional website for B Lab in Europe offers information and resources tailored to the European context. [https://bcorporation.eu](https://bcorporation.eu)

*   **B Corp Case Studies:** A collection of case studies from B Lab Europe that showcase the diverse ways in which companies are using the B Impact Assessment to create a positive impact. [https://bcorporation.eu/resources/case-studies/](https://bcorporation.eu/resources/case-studies/)

*   **B Corp Climate Justice Case Studies:** A set of case studies from B Lab U.S. & Canada that highlight how B Corps are rooting their climate action in justice. [https://usca.bcorporation.net/zbtcz11z23zcase-studies-share-how-businesses-can-root-climate-action-in-justice/](https://usca.bcorporation.net/zbtcz11z23zcase-studies-share-how-businesses-can-root-climate-action-in-justice/)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/93-b-impact-assessment.md)
