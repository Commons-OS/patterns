---
id: pat_01kg5023x9fprav2bym0a9kb6r
page_url: https://commons-os.github.io/patterns/domain/agency-model/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/agency-model.md
slug: agency-model
title: Agency Model
aliases: [Agency Business Model, Client Service Model]
version: 1.0
...
*   **A Robust and Repeatable Sales Process:** A systematic approach to sales and marketing is crucial for generating a consistent flow of new business.
_# 6. Evidence & Impact
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/agency-model.md)
