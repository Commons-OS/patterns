---
id: pat_01kg5023wdeh98phj0xj0gajsn
page_url: https://commons-os.github.io/patterns/domain/6-corporate-social-responsibility-csr/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/6-corporate-social-responsibility-csr.md
slug: 6-corporate-social-responsibility-csr
title: Corporate Social Responsibility (CSR)
aliases: [Corporate Citizenship, Corporate Responsibility, Sustainable Business]
version: 1.0
...
1.  **Environmental Responsibility**: Also known as environmental stewardship, this principle calls for organizations to be as environmentally friendly as possible. This includes reducing pollution and waste, using renewable energy, and offsetting negative environmental impacts [2].

2.  **Ethical Responsibility**: This principle ensures fair and ethical operations concerning all stakeholders. It includes fair labor practices, ethical sourcing, and prohibiting child or forced labor [2].

3.  **Philanthropic Responsibility**: This principle involves a business's commitment to improving society through donations, foundations, or employee volunteering, regardless of whether the causes are related to the business [2].

4.  **Economic Responsibility**: This principle means that a company's financial decisions should support its commitment to doing good. It's about ensuring business operations positively impact the environment and society, not just maximizing profits. This includes investing in sustainability and diversity [1].

5.  **Accountability and Transparency**: These principles are crucial for effective CSR. Accountability means taking responsibility for a company's social and environmental impacts. Transparency means openly communicating these impacts and CSR performance to stakeholders, as emphasized in standards like ISO 26000 [1].
...
1.  **Stakeholder Engagement**: This foundational practice involves engaging with all stakeholders to understand their concerns and identify material CSR issues. For example, a company might survey employees to improve workplace satisfaction.
...
1.  **Conduct a CSR Assessment**: Assess current CSR performance by assembling a leadership team, defining CSR, identifying legal requirements, reviewing documents, and engaging stakeholders to identify material issues [4].
2.  **Develop a CSR Strategy**: Based on the assessment, develop a strategy with a long-term vision, goals, priority areas, measurable targets, and a timeline [4].
3.  **Develop CSR Commitments**: Create public, SMART (specific, measurable, achievable, relevant, and time-bound) commitments that articulate CSR goals and plans [4].
4.  **Implement CSR Commitments**: Put the CSR strategy into action by developing an integrated decision-making structure, implementing a business plan, engaging employees, and communicating efforts to stakeholders [4].
5.  **Report and Verify Progress**: Regularly report on CSR performance to stakeholders through sustainability reports (e.g., using GRI standards) and consider independent verification to enhance credibility [4].
6.  **Evaluate and Improve**: Continuously evaluate CSR performance to identify opportunities for improvement and learn from experience [4].
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/6-corporate-social-responsibility-csr.md)
