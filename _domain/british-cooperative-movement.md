---
id: pat_01kg5023xpf5gvhpaphc1bp5vv
page_url: https://commons-os.github.io/patterns/domain/british-cooperative-movement/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/british-cooperative-movement.md
slug: british-cooperative-movement
title: British Cooperative Movement
aliases: [UK Cooperative Movement]
version: 1.0
...
[1] Co-operatives UK, "Co-op Economy 2022", https://www.uk.coop/economy
[2] Co-operatives UK, "Exercise in ownership: GLL reinvests and delivers measurable public benefit", https://www.uk.coop/case-studies/exercise-ownership-gll-reinvests-and-delivers-measurable-public-benefit
...
The British Cooperative Movement, with its deep roots in mutual aid and collective self-help, demonstrates a profound and inherent alignment with the principles of the commons. The commons, in this context, refers to shared resources that are managed and governed by a community for the benefit of all its members, rather than for private profit. The co-operative model, as it has evolved in the UK, provides a powerful legal and organizational framework for creating and sustaining various forms of commons, from consumer and worker co-operatives to community-owned assets and digital platforms.

At its core, the co-operative movement is a rejection of the enclosure of the economy by private interests. The Rochdale Pioneers, in their original vision, sought to create a system where the economic benefits of their collective efforts would be shared among the members, rather than being extracted by a small number of owners. This is a direct expression of the commons principle of shared ownership and control. The practice of the patronage dividend, or "divi," is a tangible manifestation of this, returning the surplus generated by the co-operative to the members who created it through their participation. This stands in stark contrast to the investor-owned model, where the primary objective is to maximize returns for shareholders.

The principle of democratic member control is another key area of alignment with the commons. In a co-operative, each member has an equal say in the governance of the organization, regardless of their financial stake. This ensures that the co-operative is accountable to its members and that its decisions are made in the best interests of the community it serves. This democratic governance structure is essential for the sustainable management of a commons, as it provides a mechanism for resolving conflicts, adapting to changing circumstances, and ensuring that the resource is not depleted or degraded over time.

The co-operative commitment to education, training, and information also strengthens its alignment with the commons. By investing in the knowledge and skills of its members, co-operatives empower them to participate effectively in the governance of the organization and to become active and engaged citizens. This focus on education is crucial for the long-term health of a commons, as it ensures that the community has the capacity to manage the resource effectively and to pass on its knowledge and values to future generations.

Furthermore, the principle of co-operation among co-operatives fosters the creation of a wider commons of shared resources and mutual support. By working together, co-operatives can create their own supply chains, financial institutions, and educational programs, reducing their dependence on the mainstream market and strengthening their collective resilience. This network of co-operation creates a powerful ecosystem of mutual support that can help to protect and expand the commons.

The growing movement for community ownership of assets, such as pubs, shops, and renewable energy projects, is a powerful contemporary expression of the commons in action, and one that is often facilitated by the co-operative model. These community-owned enterprises are a direct response to the hollowing out of local economies and the loss of essential services. By taking collective ownership of these assets, communities are reclaiming a degree of control over their own economic destiny and creating new forms of commons that are rooted in place and responsive to local needs.

In the digital realm, the rise of platform co-operatives offers a promising alternative to the extractive model of the dominant tech giants. By creating online platforms that are owned and governed by their users, platform co-operatives are building a new digital commons where data is treated as a shared resource rather than a private commodity. This is a crucial development in the ongoing struggle to create a more democratic and equitable digital economy.

In conclusion, the British Cooperative Movement, with its emphasis on shared ownership, democratic control, education, and co-operation, provides a rich and inspiring example of the commons in action. It offers a practical and proven model for building a more just, sustainable, and democratic economy, one that is rooted in the values of community, solidarity, and mutual respect.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/british-cooperative-movement.md)
