---
id: pat_01kg5023w9f70agabwqbp52gwq
page_url: https://commons-os.github.io/patterns/domain/45-ge-mckinsey-matrix/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/45-ge-mckinsey-matrix.md
slug: 45-ge-mckinsey-matrix
title: GE-McKinsey Matrix
aliases: [GE nine-box matrix, McKinsey nine-box matrix]
version: 1.0
...
sources: ["https://www.mckinsey.com/capabilities/strategy-and-corporate-finance/our-insights/enduring-ideas-the-ge-and-mckinsey-nine-box-matrix", "https://www.cascade.app/blog/ge-matrix", "https://boardmix.com/analysis/ge-mckinsey-matrix-examples/", "https://strategicmanagementinsight.com/tools/ge-mckinsey-matrix/", "https://managementconsulted.com/ge-mckinsey-matrix/"]
...
1.  **Define the criteria:** The first step is to define the specific criteria that will be used to assess industry attractiveness and business unit strength. This is a critical step, as the choice of criteria will have a significant impact on the outcome of the analysis. It is important to select criteria that are relevant to the specific industry and strategic context of the company.
2.  **Gather and score data:** The next step is to gather the necessary data and to score each business unit on the selected criteria. This can be a time-consuming process, but it is essential to ensure that the analysis is based on a solid foundation of evidence.
3.  **Plot the business units:** Once the data has been gathered and scored, the next step is to plot each business unit on the nine-box matrix. This provides a visual representation of the portfolio and helps to identify the relative position of each business.
4.  **Develop strategic actions:** Based on the position of each business unit on the matrix, the next step is to develop specific and actionable strategic recommendations. This is the heart of the analysis, and it requires a deep understanding of the business and its strategic context.
5.  **Communicate and implement:** The final step is to communicate the results of the analysis and the strategic plan to the organization, and to put in place the necessary processes and resources to implement the plan. This requires strong leadership and a clear commitment to execution.
**Common Challenges:**
...
*   **Tools & Platforms:**
    ...
    *   Boardmix
*   **References:**
    [1] McKinsey & Company. (2008, September 1). *Enduring Ideas: The GE–McKinsey nine-box matrix*. https://www.mckinsey.com/capabilities/strategy-and-corporate-finance/our-insights/enduring-ideas-the-ge-and-mckinsey-nine-box-matrix
    [2] Cascade. (2024, December 30). *McKinsey GE Matrix: Importance & How To Use It (2025)*. https://www.cascade.app/blog/ge-matrix
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/45-ge-mckinsey-matrix.md)
