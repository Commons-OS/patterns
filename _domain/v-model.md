...
page_url: https://commons-os.github.io/patterns/domain/v-model/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/v-model.md
slug: v-model
title: V-Model
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/v-model.md)
