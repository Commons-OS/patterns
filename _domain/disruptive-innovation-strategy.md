---
id: pat_01kg5023yeebha23tbn8bbtz7a
page_url: https://commons-os.github.io/patterns/domain/disruptive-innovation-strategy/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/disruptive-innovation-strategy.md
slug: disruptive-innovation-strategy
...
The Disruptive Innovation Strategy, while a powerful engine for economic growth and market transformation, presents a complex and multifaceted relationship with the principles of a commons-based economy. The overall commons alignment score of 3 out of 5 reflects this duality, acknowledging both its potential to democratize access and its inherent ties to competitive market dynamics.

| Dimension | Score (1-5) | Rationale |
|---|---|---|
| **Openness & Accessibility** | 4 | Disruptive innovations often begin by making products and services more accessible and affordable, targeting non-consumers and underserved populations. This aligns with the commons principle of broad access. However, the ultimate goal is often market capture, which can lead to new forms of enclosure. |
| **Decentralization & Distribution** | 3 | While disruption can challenge centralized incumbents, the successful disruptor often becomes a new centralized power (e.g., Amazon, Netflix). The strategy does not inherently promote decentralized governance or ownership structures. |
| **Collaboration & Cooperation** | 2 | The strategy is fundamentally competitive, focused on displacing incumbents. It does not prioritize collaboration or the creation of shared resources in the same way that a commons-based approach would. |
| **Sustainability & Regeneration** | 3 | The environmental and social impact of disruptive innovations varies widely. While some may promote resource efficiency, the drive for market growth can also lead to unsustainable consumption patterns. The framework itself does not explicitly incorporate sustainability as a core principle. |
| **Fairness & Equity** | 3 | By targeting non-consumption, disruptive innovation can promote equity by providing access to previously unaffordable goods and services. However, the wealth generated by disruptive ventures is often concentrated in the hands of a few, which can exacerbate inequality. |
| **Purpose & Values** | 3 | The primary purpose of the Disruptive Innovation Strategy is market success and profitability. While this can align with positive social outcomes, it is not inherently driven by a commitment to the common good. |
| **Governance & Stewardship** | 2 | The governance of disruptive ventures is typically hierarchical and shareholder-driven. The strategy does not include mechanisms for community stewardship or democratic control of the resources and value created. |
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/disruptive-innovation-strategy.md)
