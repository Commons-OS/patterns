---
id: pat_01kg5023x7eg99hsc7ejqz32qd
page_url: https://commons-os.github.io/patterns/domain/adhocracy-mintzberg/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/adhocracy-mintzberg.md
...
Innovation is fostered through practices like **rapid prototyping and experimentation**. Adhocracies embrace a trial-and-error approach, quickly developing and testing new ideas, learning from failures, and iterating toward successful solutions. This 
is in stark contrast to the risk-averse nature of bureaucracies. Finally, **liaison devices** are extensively used to facilitate coordination between teams and departments. These can include task forces, integrating managers, and matrix structures, all designed to ensure that the various parts of the organization are working in concert.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/adhocracy-mintzberg.md)
