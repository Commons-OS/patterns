---
id: pat_01kg502400fggs2ayqpma37g4a
page_url: https://commons-os.github.io/patterns/domain/social-license-to-operate-miningextractive/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/social-license-to-operate-miningextractive.md
slug: social-license-to-operate-miningextractive
title: Social License to Operate - Mining/extractive
aliases: []
version: 1.0
...
tags:
  ...
  status: draft
  commons_alignment: 3
generalizes_from: ["pat_01kg5023wbfw1azjwp5zrg6cxt"]
specializes_to: []
enables: []
requires: []
related: []
...
The Social License to Operate, while originating in the corporate world, has strong alignment with the principles of the commons. It represents a shift away from a purely extractive mindset towards a more reciprocal relationship between companies and communities. This assessment evaluates the SLO against seven dimensions of commons alignment.

**1. Relationship Quality:** The SLO is fundamentally about the quality of the relationship between a company and the community. A strong SLO is built on trust, mutual respect, and open communication. This aligns with the commons principle of building strong social relationships and fostering a sense of community.

**2. Participation Revolution:** The SLO calls for a shift from a top-down, consultative approach to a more participatory and collaborative model of engagement. This is in line with the commons principle of empowering communities to participate in the decisions that affect their lives.

**3. Funding and Financing:** While the SLO does not directly address the issue of funding and financing for the commons, it does emphasize the importance of benefit sharing and community investment. This can be seen as a form of commons-based financing, where a portion of the value generated by a project is reinvested in the community.

**4. Capacity:** The SLO recognizes the importance of building the capacity of local communities to engage effectively with companies. This includes providing access to information, training, and resources. This aligns with the commons principle of building the capacity of communities to manage their own resources.

**5. Coordination:** The SLO requires a high degree of coordination between the company, the community, and other stakeholders. This is in line with the commons principle of fostering collaboration and collective action.

**6. Visibility:** The SLO promotes transparency and accountability, which are essential for building trust and ensuring that companies are held accountable for their actions. This aligns with the commons principle of making the commons visible and understandable to all.

**7. Policy:** The SLO can influence public policy by demonstrating the importance of community engagement and corporate social responsibility. This can lead to the development of new laws and regulations that support the principles of the commons.

Overall, the Social License to Operate has a moderate to high degree of alignment with the principles of the commons. While it is not a perfect model, it represents a significant step forward in the evolution of corporate-community relations.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/social-license-to-operate-miningextractive.md)
