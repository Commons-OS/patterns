---
id: pat_01kg5023zqfzsrp86cw8naywp2
page_url: https://commons-os.github.io/patterns/domain/product-roadmapping/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/product-roadmapping.md
...
1.  **Establish the Foundation:** Define a clear product vision, strategy, and business objectives. The product vision should articulate the long-term aspiration for the product, while the product strategy should outline the path to achieving that vision.
2.  **Assemble the Roadmapping Team:** Create a cross-functional team of stakeholders from product, engineering, design, marketing, sales, and customer support. The product manager usually takes the lead in facilitating the roadmapping process.
3.  **Gather and Synthesize Inputs:** Collect and analyze customer feedback, market research, and stakeholder input. Synthesize these inputs to identify common themes, patterns, and priorities.
4.  **Define Strategic Themes:** Organize the roadmap around a set of strategic themes. Themes are high-level goals that provide a focus for the development efforts, such as "Improve the First-Time User Experience" or "Increase Customer Retention."
5.  **Prioritize Initiatives:** Prioritize the specific initiatives and features that will be included in the roadmap using a framework like RICE, the Kano model, or MoSCoW. The prioritization process should be a collaborative exercise.
6.  **Create the Roadmap Visualization:** Create a clear, concise, and easy-to-understand visualization of the roadmap. The roadmap should typically include the strategic themes, the key initiatives, and a high-level timeline.
7.  **Socialize and Communicate the Roadmap:** Socialize the roadmap with the rest of the organization through presentations, workshops, and all-hands meetings. Make the roadmap easily accessible to everyone in the organization.
8.  **Execute, Monitor, and Adapt:** The product roadmap is a living artifact that needs to be continuously monitored and adapted. Have a regular cadence for reviewing the roadmap and for making adjustments as needed.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/product-roadmapping.md)
