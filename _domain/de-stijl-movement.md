---
id: pat_01kg5023y7e50rxp3f7nxqpsnw
page_url: https://commons-os.github.io/patterns/domain/de-stijl-movement/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/de-stijl-movement.md
slug: de-stijl-movement
title: De Stijl Movement
aliases: []
version: 1.0
...
*   **Application of Neo-Plasticism in Painting:** In painting, artists like Piet Mondrian and Theo van Doesburg applied the principles of Neo-Plasticism to create purely abstract compositions. They used a grid of horizontal and vertical black lines to divide the canvas into rectangular areas, which were then filled with primary colors or non-colors. The goal was to create a sense of harmony and order, with each element in the composition carefully balanced.

*   **Integration of Art and Architecture:** De Stijl architects sought to create a new kind of architecture that was in harmony with the principles of the movement. They designed buildings with clean lines, geometric forms, and open-plan interiors. The use of primary colors was often integrated into the architectural design, with colored planes and surfaces used to create a sense of dynamism and to articulate the spatial composition. The Rietveld Schröder House, designed by Gerrit Rietveld, is the most famous example of De Stijl architecture.

*   **Functional and Geometric Furniture Design:** De Stijl furniture design was characterized by its geometric simplicity and functionality. Gerrit Rietveld's Red and Blue Chair is a prime example of this approach. The chair is constructed from a series of intersecting wooden slats and planes, with the colors used to articulate the different components of the chair. The design is both a functional object and a three-dimensional manifestation of De Stijl's artistic principles.
...
*   **Organizational Structure:** The principles of De Stijl can be used to design organizational structures that are simple, clear, and easy to understand. This can be achieved by reducing the number of hierarchical levels, clarifying roles and responsibilities, and creating clear lines of communication.

*   **Business Processes:** The De Stijl pattern can be used to streamline business processes and to eliminate unnecessary complexity. This can be achieved by mapping out existing processes, identifying areas of waste and inefficiency, and redesigning processes to be more efficient and effective.

*   **Communication:** The principles of De Stijl can be used to improve communication within an organization. This can be achieved by creating a common language, using clear and concise messaging, and creating a culture of open and transparent communication.

*   **Product and Service Design:** The De Stijl aesthetic of simplicity and functionality can be applied to the design of products and services. This can result in products that are not only visually appealing but also easy to use and understand.
...
The De Stijl movement, with its focus on universal principles and the creation of a shared visual language, has a complex and multifaceted relationship with the concept of the commons. The following assessment evaluates the alignment of the De Stijl pattern with the seven dimensions of the commons:

1.  **Community and Culture:** De Stijl fostered a strong sense of community among its members, who were united by a shared vision and a common set of principles. The movement's journal, *De Stijl*, served as a platform for the exchange of ideas and the development of a shared culture. However, the movement's focus on a small, elite group of artists and intellectuals limited its broader cultural impact.

2.  **Knowledge and Learning:** The De Stijl movement placed a strong emphasis on the development and dissemination of knowledge. The movement's journal, manifestos, and theoretical writings were all aimed at educating the public about the principles of Neo-Plasticism. However, the movement's esoteric and highly theoretical nature made it inaccessible to a wider audience.

3.  **Governance and Decision-Making:** The De Stijl movement was largely governed by its founder, Theo van Doesburg, who played a central role in shaping its direction and ideology. While there was a degree of collaboration and debate among the members, the decision-making process was ultimately centralized. This hierarchical structure is at odds with the more distributed and participatory models of governance that are typically associated with the commons.

4.  **Technology and Infrastructure:** The De Stijl movement embraced new technologies and materials, and it sought to create a new kind of art and architecture that was in harmony with the industrial age. The movement's focus on standardization and modularity can be seen as a precursor to the open-source and interoperable technologies that are at the heart of the digital commons.

5.  **Economy and Livelihoods:** The De Stijl movement did not have a well-defined economic model, and its members were largely dependent on a small group of patrons and collectors. The movement's utopian vision of a world where art and life are seamlessly integrated did not translate into a sustainable economic model for its members.

6.  **Legal and Ethical Frameworks:** The De Stijl movement did not have a formal legal or ethical framework, and its members were largely guided by a shared set of principles and values. The movement's emphasis on universality and the creation of a shared visual language can be seen as a precursor to the open-source and creative commons licenses that are used to govern the digital commons.

7.  **Ecology and Sustainability:** The De Stijl movement did not have an explicit focus on ecology or sustainability. However, its emphasis on simplicity, efficiency, and the use of basic materials can be seen as a precursor to the minimalist and sustainable design principles that are gaining traction today.

Overall, the De Stijl movement has a mixed alignment with the principles of the commons. While its emphasis on community, knowledge sharing, and the creation of a universal visual language is in harmony with the commons, its hierarchical governance structure and lack of a sustainable economic model are at odds with the more distributed and participatory models of the commons.

## 9. Resources & References

*   **The Art Story. "De Stijl Movement Overview."** [https://www.theartstory.org/movement/de-stijl/](https://www.theartstory.org/movement/de-stijl/)
*   **Wikipedia. "De Stijl."** [https://en.wikipedia.org/wiki/De_Stijl](https://en.wikipedia.org/wiki/De_Stijl)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/de-stijl-movement.md)
