---
id: pat_01kg5023xpf5gvhpapj70xrcn8
page_url: https://commons-os.github.io/patterns/domain/brokerage-model/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/brokerage-model.md
slug: brokerage-model
title: Brokerage Model
aliases: [Broker Model, Intermediary Model]
version: 1.0
...
sources: ["https://www.encyclopedia.com/economics/encyclopedias-almanacs-transcripts-and-maps/brokerage-model", "https://www.investopedia.com/terms/b/brokerage-company.asp"]
...
-   **Scale**: The Brokerage Model can be applied across all scales, from an individual freelance agent connecting a few clients to a global platform with millions of users. The principles of intermediation, market creation, and value capture remain the same, regardless of the scale.
...
The Brokerage Model, in its various forms, presents a complex case for commons alignment. While it can create significant value and increase market access, its alignment with commons principles depends heavily on its governance structure and the distribution of value among its stakeholders.

1.  **Stakeholder Mapping**: The primary stakeholders in a brokerage model are the buyers, the sellers, and the broker (the platform owner). However, a broader view would also include the communities in which the brokerage operates, the employees of the brokerage, and even the environment, depending on the nature of the goods or services being exchanged. The comprehensiveness of stakeholder mapping varies significantly. Traditional, profit-maximizing brokerages often focus narrowly on the transactional participants, while more commons-aligned models may actively engage with a wider range of stakeholders.

2.  **Value Creation**: The Brokerage Model creates value by reducing transaction costs, increasing market efficiency, and enabling new forms of exchange. The primary beneficiaries are typically the buyers, who get access to a wider selection and lower prices, and the sellers, who get access to a larger market. The broker captures a portion of this value in the form of fees or commissions. The extent to which this value is shared equitably depends on the broker's fee structure and the power dynamics between the broker and the other participants.

3.  **Value Preservation**: The relevance and value of a brokerage platform are maintained through continuous innovation, adaptation to changing market conditions, and the cultivation of a strong and engaged user base. The network effects inherent in the model can create a powerful lock-in effect, which can be both a source of value preservation and a barrier to entry for new competitors. From a commons perspective, the key question is whether this value is being preserved for the benefit of all participants or primarily for the benefit of the platform owner.

4.  **Shared Rights & Responsibilities**: In a traditional brokerage model, the rights and responsibilities are often skewed in favor of the broker. The broker sets the rules of the platform, controls the data, and has the power to suspend or terminate users. A more commons-aligned approach would involve a more equitable distribution of rights and responsibilities, with users having a greater say in the governance of the platform and a greater share in the value they help to create.

5.  **Systematic Design**: The systems and processes that enable the brokerage model are typically designed to maximize efficiency and profitability. This can lead to a high degree of standardization and automation, which can be both a strength and a weakness. While it can make the platform more scalable and accessible, it can also lead to a loss of human connection and a sense of alienation among users. A more commons-aligned design would prioritize human-centricity and social value alongside economic efficiency.

6.  **Systems of Systems**: The Brokerage Model is highly composable and can be integrated with a wide range of other patterns and systems. For example, a brokerage platform can be integrated with a payment system, a logistics system, and a reputation system. This composability is a key source of the model's power and versatility. From a commons perspective, the key question is whether this integration is being used to create a more open and interoperable ecosystem or a more closed and proprietary one.

7.  **Fractal Properties**: The core principles of the brokerage model can be applied at multiple scales, from a small, local exchange to a large, global platform. This fractal nature is a testament to the model's robustness and adaptability. However, it also means that the potential for both positive and negative externalities can be amplified as the model scales. A commons-aligned approach would seek to ensure that the model is implemented in a way that is sensitive to the local context and that the benefits are shared equitably at all scales.

**Overall Score**: 3/5 (Transitional)

The Brokerage Model, in its most common implementations, is best described as transitional. It has the potential to be highly commons-aligned, but it can also be highly extractive. The key determinant is the governance structure of the platform and the extent to which it empowers its users and shares value with them. There are many opportunities to improve the commons alignment of the brokerage model, such as by adopting more cooperative ownership structures, implementing more transparent and participatory governance mechanisms, and investing in the social and environmental well-being of the communities in which it operates.
...
- **Page URL**: [https://commons-os.github.io/patterns/domain/brokerage-model/](https://commons-os.github.io/patterns/domain/brokerage-model/)
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/brokerage-model.md)
- **Edit**: [Edit this pattern](https://github.com/commons-os/patterns/edit/main/_domain/brokerage-model.md)
