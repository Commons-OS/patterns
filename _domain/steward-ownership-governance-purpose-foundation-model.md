---
id: pat_01kg502402e8s98e5wnmbwpntc
page_url: https://commons-os.github.io/patterns/domain/steward-ownership-governance-purpose-foundation-model/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/steward-ownership-governance-purpose-foundation-model.md
slug: steward-ownership-governance-purpose-foundation-model
title: Steward-Ownership Governance - Purpose Foundation Model
aliases: [Purpose Foundation Model, Golden Share Model with Purpose Foundation]
version: 1.0
...
sources: [https://www.purpose-us.com/writing/top-10-faqs-on-stewardship-models, https://purpose-economy.org/en/whats-steward-ownership/, https://gailnet.org/wp-content/uploads/2023/11/purpose-guidebook-for-lawyers10022021.pdf]
...
1.  **Self-Governance and Independence**. Control of the company remains with the stewards, who are chosen for their commitment to the company's mission, not their capital contribution. Voting rights are separated from economic rights and cannot be sold or inherited, ensuring the company's independence from speculative pressures.

2.  **Profits Serve Purpose**. Profits are a means to an end, not the end itself. They are reinvested in the business, shared with stakeholders, or donated to charity, ensuring the company's financial success serves its purpose.

3.  **Long-Term Orientation**. Freed from short-term profit demands, the company can focus on long-term value creation, innovation, and resilience, building strong stakeholder relationships.

4.  **Equitable Value Distribution**. Value is shared among all stakeholders who contribute to its creation, including employees, customers, and the community, fostering a more inclusive form of capitalism.
...
1.  **Golden Share with Veto Power**. A non-profit entity holds a 'golden share' with the power to veto any changes to the company's steward-ownership structure, acting as a permanent guardian of its purpose.

2.  **Dual-Class Share Structure**. The company creates two classes of shares: steward shares with voting rights but no economic rights, and investor/founder shares with economic rights but no voting rights.

3.  **Steward Committee and Succession**. A Steward Committee, composed of individuals committed to the company's mission, holds the voting control. A clear succession plan ensures that stewardship is passed on to capable and aligned successors.

4.  **Defined Profit Allocation and Capped Returns**. The company's articles of association define how profits are allocated, with a focus on reinvestment and stakeholder value. Returns to investors are often capped to prevent the profit motive from overriding the company's purpose.

5.  **Mission-Locked Articles of Association**. The company's mission and steward-ownership principles are legally embedded in its articles of association, making them difficult to change.
...
- **Prerequisites**: A deep commitment from founders, a clear purpose, and expert legal and financial advice are essential.

- **Getting Started**: The process involves educating stakeholders, assessing the legal and financial situation, designing the new structure, creating a transition plan, and executing the legal changes.

- **Common Challenges**: Finding aligned investors, navigating legal complexity, and managing the cultural shift are common hurdles.

- **Success Factors**: Success depends on strong leadership, robust governance, engaged stewards, and transparent communication.
### 6. Evidence & Impact
...
The Steward-Ownership Governance model, particularly when implemented with the Purpose Foundation as a golden shareholder, demonstrates a significant alignment with the principles of a commons-based economy. This assessment evaluates the pattern against the seven dimensions of commons alignment.

1.  **Stakeholder Mapping**: The model inherently promotes a comprehensive mapping of stakeholders. By separating voting and economic rights, it forces a conscious decision about who should have a voice in the company's governance. The stewards, who hold the voting control, are chosen for their connection to the company's mission, and often include representatives from various stakeholder groups, such as employees, customers, and community members. This is a significant departure from the conventional model, where the only stakeholder that truly matters is the shareholder.

2.  **Value Creation**: Steward-ownership shifts the focus of value creation from maximizing shareholder wealth to creating value for a broader set of stakeholders. The "profits serve purpose" principle ensures that the financial value generated by the company is reinvested to further its mission, improve its products and services, and benefit its employees and the community. This model recognizes that value is co-created by all stakeholders and seeks to distribute it more equitably.

3.  **Value Preservation**: The model is explicitly designed for long-term value preservation. The de-commodification of the enterprise, achieved through the non-transferable nature of voting rights and the golden share veto, protects the company from being sold or dismantled for short-term gain. This ensures that the company's purpose, values, and stakeholder relationships are preserved for future generations.

4.  **Shared Rights & Responsibilities**: Steward-ownership provides a clear framework for distributing rights and responsibilities. The stewards have the right and responsibility to govern the company in a way that is true to its purpose. Investors have the right to a fair return on their investment, but not the right to control the company. Employees have the right to a fair wage and good working conditions, and in some cases, a share of the profits. This clear and equitable distribution of rights and responsibilities is a hallmark of a commons-based approach.

5.  **Systematic Design**: The Steward-Ownership Governance model is a systematic design for a purpose-driven enterprise. The legal and governance structures are carefully designed to create a system where the company's purpose is the central organizing principle. The dual-class share structure, the golden share, the Steward Committee, and the defined profit allocation are all interconnected components of a system that is designed to be self-perpetuating and resilient.

6.  **Systems of Systems**: Steward-owned companies can be seen as building blocks for a larger "system of systems"—a purpose-driven economy. As more companies adopt this model, they can create a network of aligned organizations that can collaborate to address complex social and environmental challenges. The Purpose Foundation itself acts as a hub for this network, providing support, resources, and a shared identity for steward-owned companies.

7.  **Fractal Properties**: The principles of steward-ownership can be applied at different scales, demonstrating fractal properties. A single team or department within a larger organization could be structured as a steward-owned unit, with its own purpose, stewards, and stakeholder agreements. This would allow for greater autonomy and purpose-driven decision-making at all levels of the organization.

**Overall Score: 4/5 (Commons-Aligned)**

The Steward-Ownership Governance - Purpose Foundation Model is a powerful example of a commons-aligned approach to corporate governance. It provides a robust legal and financial framework for creating companies that are purpose-driven, stakeholder-oriented, and built for the long term. While it is not a perfect solution, and its implementation can be challenging, it represents a significant step towards a more equitable and sustainable economy.

**Opportunities for Improvement**:

While the model is strong, there are opportunities to further enhance its commons alignment. These include developing more robust mechanisms for stakeholder participation in governance, creating more innovative financing models that are even more aligned with the principles of a commons, and fostering a stronger ecosystem of support for steward-owned companies.
...
- **Page URL**: [https://commons-os.github.io/patterns/domain/steward-ownership-governance-purpose-foundation-model/](https://commons-os.github.io/patterns/domain/steward-ownership-governance-purpose-foundation-model/)
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/steward-ownership-governance-purpose-foundation-model.md)
- **Edit**: [Edit this pattern](https://github.com/commons-os/patterns/edit/main/_domain/steward-ownership-governance-purpose-foundation-model.md)
