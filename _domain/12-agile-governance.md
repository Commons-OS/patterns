---
id: pat_01kg5023vwe00rptkqr3z6pkd9
page_url: https://commons-os.github.io/patterns/domain/12-agile-governance/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/12-agile-governance.md
slug: 12-agile-governance
...
sources: ["https://www.agilebusiness.org/business-agility/framework-for-business-agility/agile-governance.html", "https://agilemania.com/what-is-agile-governance", "https://www.smartsheet.com/content/agile-governance", "https://www.smartsheet.com/content/agile-project-management-examples", "https://www.oecd.org/en/publications/case-studies-on-agile-regulatory-governance-to-harness-innovation_0fa5e0e6-en.html"]
...
*   **Agile Business Consortium. (n.d.). *What is Agile Governance?* Retrieved from [https://www.agilebusiness.org/business-agility/framework-for-business-agility/agile-governance.html](https://www.agilebusiness.org/business-agility/framework-for-business-agility/agile-governance.html)**: A concise overview of Agile Governance from the organization that created the Agile Business Analysis (AgileBA) certification.
*   **Agilemania. (2022, February 12). *What is Agile Governance: 4 Guiding Principles in Agile*. Retrieved from [https://agilemania.com/what-is-agile-governance](https://agilemania.com/what-is-agile-governance)**: This article provides a clear and accessible introduction to the core principles of Agile Governance.
*   **Smartsheet. (2020, February 18). *Tips for Agile Project Governance*. Retrieved from [https://www.smartsheet.com/content/agile-governance](https://www.smartsheet.com/content/agile-governance)**: A practical guide to implementing Agile Governance, with tips and best practices.
*   **Smartsheet. (2024, August 26). *Real-Life Agile Project Management & Famous Success Stories*. Retrieved from [https://www.smartsheet.com/content/agile-project-management-examples](https://www.smartsheet.com/content/agile-project-management-examples)**: Provides case studies and examples of companies that have successfully implemented Agile.
*   **OECD. (2022). *Case studies on agile regulatory governance to harness innovation*. OECD Regulatory Policy Working Papers, No. 18. Retrieved from [https://www.oecd.org/en/publications/case-studies-on-agile-regulatory-governance-to-harness-innovation_0fa5e0e6-en.html](https://www.oecd.org/en/publications/case-studies-on-agile-regulatory-governance-to-harness-innovation_0fa5e0e6-en.html)**: This paper presents case studies on the application of agile principles in regulatory governance.
...
[1] Agile Business Consortium. (n.d.). *What is Agile Governance?* Retrieved from [https://www.agilebusiness.org/business-agility/framework-for-business-agility/agile-governance.html](https://www.agilebusiness.org/business-agility/framework-for-business-agility/agile-governance.html)

[2] Agilemania. (2022, February 12). *What is Agile Governance: 4 Guiding Principles in Agile*. Retrieved from [https://agilemania.com/what-is-agile-governance](https://agilemania.com/what-is-agile-governance)

[3] Smartsheet. (2020, February 18). *Tips for Agile Project Governance*. Retrieved from [https://www.smartsheet.com/content/agile-governance](https://www.smartsheet.com/content/agile-governance)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/12-agile-governance.md)
