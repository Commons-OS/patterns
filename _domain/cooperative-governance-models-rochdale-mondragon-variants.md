---
id: pat_01kg5023y5fnhb2ej693e8ms5d
page_url: https://commons-os.github.io/patterns/domain/cooperative-governance-models-rochdale-mondragon-variants/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/cooperative-governance-models-rochdale-mondragon-variants.md
slug: cooperative-governance-models-rochdale-mondragon-variants
title: Cooperative Governance Models (Rochdale, Mondragon Variants)
aliases: [Cooperative Federalism, Co-op Governance]
version: 1.0
...
tags:
  ...
  origin: [rochdale-pioneers, mondragon-corporation]
  status: draft
  commons_alignment: 5
generalizes_from: []
specializes_to: []
...
1.  [Rochdale Principles - Wikipedia](https://en.wikipedia.org/wiki/Rochdale_Principles)
2.  [Mondragon Corporation - Wikipedia](https://en.wikipedia.org/wiki/Mondragon_Corporation)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/cooperative-governance-models-rochdale-mondragon-variants.md)
