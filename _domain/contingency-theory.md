---
id: pat_01kg5023y3etg8p54y37f9vpz4
page_url: https://commons-os.github.io/patterns/domain/contingency-theory/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/contingency-theory.md
slug: contingency-theory
...
tags:
  universality: domain
  domain: meta
  category: [framework, principle, meta-pattern]
...
5.  [Fiedler contingency model - Wikipedia](https://en.wikipedia.org/wiki/Fiedler_contingency_model)
6.  [Contingency Theory: Mastering Leadership Flexibility - PositivePsychology.com](https://positivepsychology.com/contingency-theory/)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/contingency-theory.md)
