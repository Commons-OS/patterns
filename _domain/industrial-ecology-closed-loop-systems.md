---
id: pat_01kg5023z6f40rvkrsnzmmc3vf
page_url: https://commons-os.github.io/patterns/domain/industrial-ecology-closed-loop-systems/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/industrial-ecology-closed-loop-systems.md
...
*   **Essential Reading:**
    ...
    *   Chertow, M. R. (2000). Industrial Symbiosis: Literature and Taxonomy. *Annual Review of Energy and the Environment*, *25*(1), 313–337. - A comprehensive review of the industrial symbiosis literature.
    *   Ehrenfeld, J. R., & Gertler, N. (1997). Industrial Ecology in Practice: The Evolution of Interdependence at Kalundborg. *Journal of Industrial Ecology*, *1*(1), 67–79. - A detailed case study of the Kalundborg Symbiosis.
...
*   **Organizations & Communities:**
    ...
    *   **Journal of Industrial Ecology:** The premier academic journal in the field of industrial ecology.
...
*   **Tools & Platforms:**
    *   **SimaPro:** A leading life-cycle assessment software tool.
    *   **GaBi:** Another widely used life-cycle assessment software tool.
    *   **Umberto:** A software tool for material and energy flow analysis.

*   **References:**
    1.  [CSIS. (2021). *Industrial Ecology: Closing a Loop in Circularity*.](https://www.csis.org/analysis/industrial-ecology-closing-loop-circularity)
    2.  [Wikipedia. (n.d.). *Industrial ecology*.](https://en.wikipedia.org/wiki/Industrial_ecology)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/industrial-ecology-closed-loop-systems.md)
