---
id: pat_01kg5023wae40t6kxjezfm51xy
page_url: https://commons-os.github.io/patterns/domain/47-farm-to-table/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/47-farm-to-table.md
slug: 47-farm-to-table
title: Farm-to-Table
aliases: [Farm-to-Fork, Farm-to-School]
version: 1.0
...
1.  **Define Sourcing Radius**: Define what “local” means to you (e.g., 100-mile radius).
2.  **Build Farmer Relationships**: Visit local farms and farmers’ markets to connect with producers.
3.  **Start Small & Scale**: Begin by incorporating a few local ingredients and gradually increase.
4.  **Embrace Seasonality**: Design menus around what is fresh and abundant.
5.  **Tell Your Story**: Share your farm-to-table journey with your customers.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/47-farm-to-table.md)
