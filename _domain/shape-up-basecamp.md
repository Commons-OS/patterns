---
id: pat_01kg5023zyebsatbkr1pwp0q04
page_url: https://commons-os.github.io/patterns/domain/shape-up-basecamp/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/shape-up-basecamp.md
slug: shape-up-basecamp
...
---
_A brief introduction to the pattern, its purpose, and key components._
...
_The fundamental ideas and beliefs that underpin the pattern._
...
_Specific, actionable techniques and processes that are part of the pattern._
...
_The types of situations, environments, or problems for which this pattern is well-suited._
...
_Guidance on how to introduce and apply the pattern in a real-world setting._
...
_How the pattern might evolve or be applied in the context of AI, machine learning, and other cognitive technologies._
...
_A curated list of external resources, including articles, books, and tools related to the pattern._

*   **[1] Singer, Ryan. *Shape Up: Stop Running in Circles and Ship Work that Matters*. Basecamp. [https://basecamp.com/shapeup](https://basecamp.com/shapeup)
*   **[2] Curious Lab. "What is Basecamp's Shape Up method?: A complete overview."** [https://www.curiouslab.io/blog/what-is-basecamps-shape-up-method-a-complete-overview](https://www.curiouslab.io/blog/what-is-basecamps-shape-up-method-a-complete-overview)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/shape-up-basecamp.md)
