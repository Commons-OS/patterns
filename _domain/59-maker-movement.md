---
id: pat_01kg5023wdeh98phj0t4jdgd0v
page_url: https://commons-os.github.io/patterns/domain/59-maker-movement/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/59-maker-movement.md
slug: 59-maker-movement
title: Maker Movement
aliases: [Maker Culture, DIY Movement]
version: 1.0
...
tags:
  ...
  category: [practice]
  era: [digital]
  origin: [make-magazine]
  status: draft
  commons_alignment: 3
commons_domain: business
generalizes_from: []
specializes_to: ["pat_01kg5023zde79btwvkh6whd7af"]
enables: []
requires: []
related: []
contributors: [higgerix, cloudsters]
sources: ["Dougherty, 2012", "Martinez & Stager, 2013", "Browder, Aldrich, & Bradley, 2019", "Voigt & Unterfrauner, 2020", "Singh, 2018"]
...
The Maker Movement engages a broad and diverse range of stakeholders. At its core are the **makers** themselves—hobbyists, students, entrepreneurs, and artists who are the primary creators and innovators. They are supported by a network of **makerspace operators** and **community organizers** who provide the physical infrastructure and social fabric for the movement. **Educators** and **academic institutions** are also key stakeholders, integrating making into their curricula to foster STEM/STEAM skills. **Technology companies** play a significant role by developing and providing the tools and platforms that power the movement. Finally, the **general public** is a stakeholder as both a potential participant and a beneficiary of the innovations and knowledge generated by the movement. The movement's decentralized and open nature allows for a high degree of inclusivity, but there is a risk of digital and economic divides creating barriers to entry for some.

**2. Value Creation**

The Maker Movement creates value in multiple forms. For individuals, it provides **personal fulfillment**, **skill development**, and a sense of **empowerment**. For communities, it fosters **social cohesion**, **collaboration**, and **local problem-solving**. Economically, it drives **innovation**, creates **new businesses**, and contributes to a more **resilient and distributed manufacturing ecosystem**. The value created is largely distributed among the participants, with makers retaining ownership of their creations and the community benefiting from the open sharing of knowledge and designs. However, the commercialization of the movement by large corporations raises questions about the equitable distribution of value.

**3. Value Preservation**

The Maker Movement's relevance is maintained through its constant evolution and adaptation to new technologies and societal needs. The open-source nature of the movement ensures that knowledge and designs are preserved and built upon by future generations of makers. The decentralized and distributed nature of the movement also makes it resilient to the failure of any single entity. However, the reliance on digital platforms and proprietary software for some tools and designs poses a risk to the long-term preservation of the commons.

**4. Shared Rights & Responsibilities**

The Maker Movement operates on a largely informal system of shared rights and responsibilities. The use of open-source licenses for hardware and software is a common practice, ensuring that designs can be freely used, modified, and shared. The responsibility for maintaining the commons is distributed among the community, with individuals contributing to the collective knowledge base through their projects and documentation. However, the lack of formal governance structures can lead to challenges in resolving disputes and ensuring the quality and reliability of shared designs.

**5. Systematic Design**

The Maker Movement is characterized by a set of systematic processes and practices that enable its functioning. These include the use of digital design tools, version control systems for collaborative projects, and online platforms for knowledge sharing. Makerspaces also provide a systematic environment for making, with established safety procedures and workflows. The movement's reliance on modular and interoperable components, such as the Arduino and Raspberry Pi platforms, also contributes to its systematic nature.

**6. Systems of Systems**

The Maker Movement is a highly compositional system that integrates with and builds upon other patterns and systems. It is closely linked to the **Open Source Movement**, the **DIY Movement**, and the **Creative Commons**. It also interacts with the formal economy, with maker-led businesses emerging and large corporations engaging with the movement. The movement's ability to compose with other systems is a key factor in its adaptability and resilience.

**7. Fractal Properties**

The core principles of the Maker Movement—learning through doing, collaboration, and open sharing—are evident at all scales, from the individual maker to the global community. An individual maker working on a project in their garage embodies the same spirit of experimentation and creativity as a large-scale Maker Faire. This fractal nature allows the movement to scale and adapt to different contexts while maintaining its core identity.

**Overall Score: 3/5 (Transitional)**

The Maker Movement is a powerful force for democratization, empowerment, and innovation. Its open and collaborative nature aligns well with the principles of a commons-based approach. However, the increasing commercialization of the movement and its reliance on proprietary platforms and tools pose a threat to its commons-oriented values. To improve its commons alignment, the movement could focus on developing more robust governance structures, promoting the use of open standards and protocols, and ensuring that the value created is equitably distributed among all stakeholders.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/59-maker-movement.md)
