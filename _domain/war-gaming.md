---
id: pat_01kg50240dfc193dybww4825d7
page_url: https://commons-os.github.io/patterns/domain/war-gaming/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/war-gaming.md
slug: war-gaming
title: War Gaming
aliases: []
version: 1.0
...
**4. Continuous and Automated War Gaming:** In the Cognitive Era, War Gaming can evolve from a periodic, event-based activity to a continuous and automated process. AI-powered War Gaming platforms can run simulations on an ongoing basis, constantly testing and refining the organization's strategy in response to changing market conditions. This can provide a real-time 
feed of strategic intelligence and allow the organization to adapt to the competitive landscape with greater speed and agility.
...
1.  [Business war games - Wikipedia](https://en.wikipedia.org/wiki/Business_war_games)
2.  [Business Wargaming Explained in Depth - Strategic Management Insight](https://strategicmanagementinsight.com/tools/business-wargaming-explained/)
3.  [Playing war games to win - McKinsey](https://www.mckinsey.com/capabilities/strategy-and-corporate-finance/our-insights/playing-war-games-to-win)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/war-gaming.md)
