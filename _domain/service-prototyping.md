---
id: pat_01kg5023zyebsatbkqrwv95fe2
page_url: https://commons-os.github.io/patterns/domain/service-prototyping/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/service-prototyping.md
slug: service-prototyping
...
**Prototyping Intelligent Services:** Prototyping AI-powered services requires new techniques that go beyond traditional methods. The 
"Wizard of Oz" technique, for example, can be used to simulate an AI-powered chatbot or a personalized recommendation engine, allowing designers to test the user experience without having to build the complex algorithms. [1]
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/service-prototyping.md)
