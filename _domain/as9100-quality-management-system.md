---
id: pat_01kg5023xge89s6mx3nbjd0mgg
page_url: https://commons-os.github.io/patterns/domain/as9100-quality-management-system/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/as9100-quality-management-system.md
slug: as9100-quality-management-system
title: AS9100 Quality Management System
aliases: [AS9100, Aerospace Quality Management System]
version: 1.0
...
enables: []
requires: []
related: ["pat_01kg5023z4ejgvpxs00h779hk7", "pat_01kg5023x8evg9fk7ax23cbrbn", "pat_01kg5023wjfg8tqb1zqbg7dd8h", "pat_01kg5023vyfzhvteh04eykysqz", "pat_01kg5023zrexhr77rgbe4f62ew", "pat_01kg5023vjetsaajnc397n2n2m", "pat_01kg5023vyfzhvteh02a487gvh", "pat_01kg5023z8f6h9wk9sdad8sxxd", "pat_01kg5023x8evg9fk7as5cxmnwk", "pat_01kg5023z3f90bkx13t1xprvjz", "pat_01kg5023zcf99tjg7qgdbhqfkm", "pat_01kg5023zzecsb265cp79x0gvh", "pat_01kg5023ybeqhsr5sn20s4jgvn", "pat_01kg5023ytf2s8rdchqz3eqbg0", "pat_01kg5023yaea8sqyn9hkqb477d"]
...
**1. Stakeholder Mapping**: AS9100 has a well-defined but somewhat narrow stakeholder map. The primary stakeholders are clearly identified as customers (the major aerospace and defense contractors), regulatory bodies (like the FAA and EASA), and the organizations themselves. The standard also implicitly considers the end-users of aerospace products (passengers, military personnel) through its intense focus on safety and reliability. However, the wider community and environmental stakeholders are not explicitly addressed. The scope is largely confined to the direct participants in the aerospace supply chain.

**2. Value Creation**: The value created by AS9100 is primarily economic and functional. For certified organizations, it unlocks access to the lucrative aerospace market. For their customers, it provides assurance of quality and reliability, reducing their own risk and inspection costs. For the end-user, it contributes to the safety and reliability of air travel and defense systems. The value is largely captured by the commercial entities within the supply chain. While safety is a public good, the framework itself is not designed to distribute value beyond the immediate economic participants.

**3. Value Preservation**: AS9100 is designed for long-term value preservation. The requirement for continual improvement, the focus on risk management, and the periodic revision of the standard itself ensure that it remains relevant in the face of changing technology and emerging risks. By mandating robust processes for configuration management and documentation, it ensures that the knowledge required to produce and maintain complex aerospace systems is preserved over their long lifecycles.

**4. Shared Rights & Responsibilities**: The standard establishes a clear system of rights and responsibilities, but they are not necessarily shared in a commons-oriented way. The prime contractors have the right to demand certification, and the suppliers have the responsibility to comply. The responsibilities for quality and safety are cascaded down the supply chain, but the power dynamic is hierarchical. The IAQG, which manages the standard, is composed of representatives from the major aerospace companies, giving them a privileged position in defining the rules of the system.

**5. Systematic Design**: AS9100 is the epitome of a systematic design. It provides a comprehensive, process-based framework for managing quality across an entire organization. The standard is structured, logical, and auditable. It requires organizations to design and implement a system of interrelated processes to achieve their quality objectives. This systematic nature is one of its greatest strengths, providing a clear roadmap for organizations to follow.

**6. Systems of Systems**: AS9100 is designed to function as a system of systems. It integrates with ISO 9001 and is part of a larger family of aerospace standards (AS9110 for MRO, AS9120 for distributors). It is designed to be compatible with other management systems, such as those for environmental management (ISO 14001) and occupational health and safety (ISO 45001). The entire aerospace supply chain can be viewed as a system of systems, with AS9100 providing the common quality language that allows the different parts to interoperate.

**7. Fractal Properties**: The principles of AS9100 exhibit some fractal properties. The core principles of customer focus, process approach, and continual improvement can be applied at all levels, from a single work cell to the entire organization and across the supply chain. However, the full set of requirements is most applicable at the organizational level. While individual teams can adopt the principles, the formal structure of the QMS is an organization-wide construct.

**Overall Score: 3/5 (Transitional)**

AS9100 is a highly effective and necessary standard for the aerospace industry, but it is fundamentally a tool of industrial capitalism. It is designed to manage risk and ensure quality within a hierarchical, commercially-driven supply chain. While it creates significant value in terms of safety and reliability, its primary focus is on protecting the interests of the major aerospace corporations. It scores well on systematic design and systems thinking, but it is not designed to foster a true commons. To improve its commons alignment, the standard could be expanded to more explicitly consider the interests of a wider range of stakeholders, including the environment and the broader community. The governance of the standard could also be made more inclusive, with a greater voice for smaller suppliers and other interested parties.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/as9100-quality-management-system.md)
