---
id: pat_01kg5023wxeqsb7ey1n8q3dkqv
page_url: https://commons-os.github.io/patterns/domain/88-target-costing/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/88-target-costing.md
slug: 88-target-costing
title: Target Costing
aliases: ["Target Cost Management", "Genka Kikaku"]
version: 1.0
...
tags:
  ...
  commons_alignment: 3
generalizes_from: []
specializes_to: ["pat_01kg502404e39b225z86mg9eeg"]
enables: []
requires: []
related: []
contributors: [higgerix, cloudsters]
sources: ["https://en.wikipedia.org/wiki/Target_costing", "https://www.yourarticlelibrary.com/accounting/costing/target-costing-concept-and-7-key-principles/53103", "https://galorath.com/cost/target-costing/", "https://sloanreview.mit.edu/article/target-costing-as-a-strategic-tool/", "https://www.imanet.org/"]
...
2.  **Focus on the Customer:** Customer needs and their willingness to pay are at the heart of target costing. The features, quality, and functionality of the product are all determined by what the customer values and is willing to pay for. This customer-centric approach ensures that the product is not over-engineered with features that add cost but not value.
...
7.  **Foster Strong Supplier Relationships:** Suppliers play a crucial role in target costing. By working closely with suppliers, companies can gain access to their expertise, reduce component costs, and improve the quality of their products. For example, a company might involve its key suppliers in the design process to get their input on cost-saving opportunities.
...
1.  **Establish a Cross-Functional Team:** The first step is to assemble a dedicated team with representatives from marketing, design, engineering, procurement, production, and finance. This team will be responsible for driving the target costing process from start to finish.

2.  **Define the Target Market and Price:** The team must then conduct thorough market research to identify the target customer segment and determine a competitive selling price for the new product.

3.  **Set the Target Profit Margin and Calculate the Target Cost:** Based on the company's strategic and financial objectives, the team must establish a desired profit margin and then calculate the allowable target cost by subtracting the profit margin from the target price.

4.  **Allocate the Target Cost:** The overall target cost is then cascaded down to the various components and activities involved in the production process. This provides each team and individual with a clear cost target to work towards.

5.  **Implement Cost Reduction Strategies:** The team then employs a variety of cost reduction techniques, such as value engineering, process improvement, and supplier collaboration, to achieve the target cost without compromising on quality or customer value.

**Common Challenges**:

1.  **Resistance to Change:** One of the biggest challenges is overcoming resistance to change from employees who are accustomed to traditional cost-plus pricing methods. This can be addressed through clear communication, training, and demonstrating the benefits of target costing.

2.  **Lack of Accurate Data:** Another common challenge is the lack of accurate market and cost data. This can be overcome by investing in market research, improving cost accounting systems, and fostering closer relationships with suppliers.

3.  **Difficulty in Achieving Consensus:** Cross-functional teams can sometimes struggle to reach a consensus on design and cost trade-offs. This can be mitigated by establishing clear decision-making processes and empowering a strong team leader.

**Success Factors**:

1.  **Top Management Support:** Unwavering support from top management is the most critical success factor.

2.  **Cross-Functional Collaboration:** The ability of different departments to work together effectively is essential.

3.  **Customer Focus:** A deep understanding of customer needs and their willingness to pay is crucial.

4.  **Supplier Involvement:** Early and active involvement of suppliers in the design process can lead to significant cost savings.

5.  **Continuous Improvement:** A commitment to continuous improvement ensures that cost reduction efforts are sustained over the long term.
...
**1. Stakeholder Mapping**: Target costing, in its traditional application, primarily focuses on a narrow set of stakeholders: **customers, shareholders, and the organization itself**. The customer is central in determining the target price, while shareholders' interests are represented by the target profit margin. The organization's internal departments (design, engineering, production) are also key stakeholders in the process. However, the model often overlooks a broader set of stakeholders, such as **suppliers, employees, the community, and the environment**. While there is a focus on the value chain, the relationship with suppliers is often transactional, focused on cost reduction rather than a true partnership. The well-being of employees and the impact on the local community and the environment are typically not explicitly considered in the core target costing framework.

**2. Value Creation**: The primary form of value created by target costing is **economic value**, both for the customer (in the form of a lower price) and for the organization (in the form of profit). It also creates **functional value** for the customer by ensuring that the product meets their needs and expectations. However, it often falls short in creating other forms of value, such as **social or environmental value**. The relentless focus on cost reduction can sometimes lead to decisions that have negative social or environmental consequences, such as sourcing from low-wage countries with poor labor standards or using cheaper materials that are not environmentally friendly.

**3. Value Preservation**: Target costing is a powerful tool for **preserving economic value** over time. By continuously reducing costs and improving efficiency, it helps organizations to remain competitive and profitable in the long run. It also contributes to the preservation of **functional value** by ensuring that products continue to meet the evolving needs of customers. However, its contribution to the preservation of **social and environmental value** is limited. The model does not have a built-in mechanism for ensuring that the value created is sustained over the long term in a socially and environmentally responsible manner.

**4. Shared Rights & Responsibilities**: In a traditional target costing model, the **rights and responsibilities are not equitably distributed**. The organization retains the primary right to the profits generated, while the responsibilities for cost reduction are often pushed down to suppliers. This can create a power imbalance in the value chain and lead to the exploitation of suppliers. There is a need for a more equitable distribution of rights and responsibilities, where all stakeholders, including suppliers and employees, have a voice in the decision-making process and share in the value created.

**5. Systematic Design**: Target costing is a highly **systematic and structured process**. It provides a clear and logical framework for managing costs throughout the product life cycle. The use of cross-functional teams, value engineering, and other tools and techniques ensures that the process is well-designed and executed. However, the system is primarily designed to optimize for economic efficiency, and it lacks the mechanisms for incorporating broader social and environmental considerations into the design process.

**6. Systems of Systems**: Target costing can be seen as a **sub-system within a larger system of production and consumption**. It interacts with other systems, such as the supply chain, the market, and the regulatory environment. However, the model often operates in a silo, with a limited understanding of its interconnections with other systems. There is a need for a more holistic approach that considers the broader systemic impacts of target costing, including its effects on the environment, society, and the economy as a whole.

**7. Fractal Properties**: The core principles of target costing, such as price-led costing and customer focus, can be **applied at different scales**, from a single product to an entire organization. This fractal nature allows the pattern to be adapted to different contexts and situations. However, the limitations of the model, such as its narrow stakeholder focus and its emphasis on economic value, are also replicated at every scale.

**Overall Score: 3 (Transitional)**

Target costing, in its current form, is a **transitional pattern**. It represents a significant improvement over traditional cost-plus pricing models, but it still falls short of being a truly commons-aligned pattern. Its primary focus on economic value and its narrow stakeholder orientation limit its ability to create and preserve value for all stakeholders in a just and equitable manner. To become more commons-aligned, target costing needs to evolve to incorporate a broader set of stakeholders, a more holistic view of value, and a more equitable distribution of rights and responsibilities. This could involve integrating social and environmental costs into the target cost calculation, fostering more collaborative and long-term relationships with suppliers, and empowering employees to participate in the decision-making process.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/88-target-costing.md)
