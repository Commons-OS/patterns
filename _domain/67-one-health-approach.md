---
id: pat_01kg5023whehgsjwtbmb2thgxd
page_url: https://commons-os.github.io/patterns/domain/67-one-health-approach/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/67-one-health-approach.md
slug: 67-one-health-approach
title: One Health Approach
aliases: [One Health, One Medicine, One World]
version: 1.0
...
- **Page URL**: [https://commons-os.github.io/patterns/domain/67-one-health-approach/](https://commons-os.github.io/patterns/domain/67-one-health-approach/)
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/67-one-health-approach.md)
- **Edit**: [Edit this pattern](https://github.com/commons-os/patterns/edit/main/_domain/67-one-health-approach.md)
