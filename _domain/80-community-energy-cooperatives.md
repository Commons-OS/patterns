---
slug: 80-community-energy-cooperatives
title: Community Energy Cooperatives
aliases: [Renewable Energy Cooperatives, Energy Communities]
version: 1.0
...
Community Energy Cooperatives inherently align with commons principles, enabling communities to manage energy as a shared resource. This assessment reviews the pattern against the seven commons dimensions.

**1. Stakeholder Mapping:** Cooperatives inclusively map stakeholders, primarily member-owners who are also energy users. They also serve the broader community, including residents, businesses, and organizations. Open membership ensures broad participation, though the focus is typically on a specific geographic area.

**2. Value Creation:** Cooperatives generate economic value (lower bills, dividends, local jobs), social value (community cohesion, empowerment, energy literacy), and environmental value (renewable energy adoption, reduced emissions). Members and the wider community are the primary beneficiaries.

**3. Value Preservation:** Designed for long-term value, cooperatives use democratic governance to prioritize community interests over short-term profits. Their renewable energy focus ensures sustainability, though keeping pace with technological change is a key challenge.

**4. Shared Rights & Responsibilities:** Rights (participation, economic benefits) and responsibilities (financial contribution, responsible energy use) are shared among members. This collective ownership and control is central to the cooperative model.

**5. Systematic Design:** The cooperative model is a systematic design for collective action, with clear principles and a defined legal and governance structure. Practices like community share offers and business planning are integral to this design.

**6. Systems of Systems:** Cooperatives function as systems that can be nested within larger systems. A network of cooperatives can form a regional energy system, or a single cooperative can integrate with local food or housing systems.

**7. Fractal Properties:** The cooperative principles are fractal, applying at all scales—from a small group of neighbors to a large regional cooperative. Core principles of democratic control and community concern remain consistent regardless of size.

**Overall Score: 5 (Exemplary Commons)**

Community Energy Cooperatives are an exemplary model of a commons-based approach to energy. They embody all seven dimensions of the commons and provide a powerful alternative to the dominant, market-driven model of energy production. They are a proven and effective way to create a more just, democratic, and sustainable energy future. The main opportunity for improvement is to scale up the model to have a greater impact on the global energy system.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/80-community-energy-cooperatives.md)
