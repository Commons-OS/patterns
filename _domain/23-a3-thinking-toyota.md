---
id: pat_01kg5023w0e00tpg8ahrjezwpt
page_url: https://commons-os.github.io/patterns/domain/23-a3-thinking-toyota/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/23-a3-thinking-toyota.md
slug: 23-a3-thinking-toyota
title: A3 Thinking
aliases: [A3 Problem Solving, A3 Process, A3 Report]
version: 1.0
...
sources: [https://www.lean.org/lexicon-terms/a3-report/, https://en.wikipedia.org/wiki/A3_problem_solving, https://www.lean.org/the-lean-post/articles/using-a3-thinking-to-solve-recruiting-problems-an-interview-with-gavin-martin/, http://www.ieomsociety.org/harare2020/papers/116.pdf, https://www.redjournal.org/article/S0360-3016(14)02830-2/fulltext]
...
1.  **Theme/Background**: This section sets the context for the problem. It should briefly describe the problem and explain why it is important to solve. This helps to create a shared understanding of the issue and its impact on the organization's goals.
...
3.  **Goal/Target Condition**: This section defines the desired future state. The goal should be specific, measurable, achievable, relevant, and time-bound (SMART). It should clearly state what success will look like and how it will be measured.

4.  **Root Cause Analysis**: This is a critical step in the A3 process. Instead of jumping to solutions, the problem-solver must dig deep to identify the underlying root causes of the problem. Tools such as the "5 Whys" and fishbone diagrams are often used in this stage to facilitate the analysis.

5.  **Countermeasures**: Once the root causes have been identified, this section is used to propose countermeasures to address them. These are not just quick fixes but well-thought-out solutions that are designed to prevent the problem from recurring. It is important to consider multiple potential countermeasures and to evaluate their feasibility and potential impact.
...
1.  **Start Small**: Begin by applying the A3 process to a single, well-defined problem. This will allow the team to learn the process in a low-risk environment and to build confidence before tackling more complex issues.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/23-a3-thinking-toyota.md)
