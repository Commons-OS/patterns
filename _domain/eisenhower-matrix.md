---
id: pat_01kg5023yhepg8n3degtnd7cfb
page_url: https://commons-os.github.io/patterns/domain/eisenhower-matrix/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/eisenhower-matrix.md
...
Tasks in this quadrant require immediate attention. These are the crises, deadlines, and problems that demand to be dealt with right away. The key practice for Quadrant 1 is to **do** these tasks as soon as possible. Procrastination is not an option. It is important to be decisive and focused when working on Quadrant 1 activities to resolve them efficiently and effectively. However, the goal should be to minimize the number of tasks that end up in this quadrant by being more proactive and planning ahead.
...
This quadrant contains all the time-wasting activities that have no real value. These are the trivial tasks, bad habits, and mindless distractions that get in the way of productivity. The key practice for Quadrant 4 is to **eliminate** these activities from your life as much as possible. This requires self-awareness and discipline. By identifying and cutting out the time-wasters, you create more space for the activities that truly matter. Regularly ask yourself if a particular activity is helping you to achieve your goals. If the answer is no, it probably belongs in Quadrant 4.
...
2.  [The Eisenhower Matrix: Introduction & 3-Minute Video Tutorial](https://www.eisenhower.me/eisenhower-matrix/)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/eisenhower-matrix.md)
