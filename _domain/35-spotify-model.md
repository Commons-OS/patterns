---
id: pat_01kg5023w4eagvvdvd5vbc1hhq
page_url: https://commons-os.github.io/patterns/domain/35-spotify-model/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/35-spotify-model.md
slug: 35-spotify-model
title: Spotify Model
aliases: [Spotify Agile Model, Spotify Engineering Culture]
version: 1.0
...
tags:
  ...
  category: framework
  era: digital
  origin: [spotify, henrik-kniberg, anders-ivarsson]
  status: draft
  commons_alignment: 3
generalizes_from: []
specializes_to: ["pat_01kg50240wfjh98jqx0vjzv358"]
enables: []
requires: []
related: []
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/35-spotify-model.md)
