---
id: pat_01kg502408eg1s5s6d44048n4m
page_url: https://commons-os.github.io/patterns/domain/true-cost-accounting-externalities-included/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/true-cost-accounting-externalities-included.md
slug: true-cost-accounting-externalities-included
title: True Cost Accounting - Externalities Included
aliases: []
version: 1.0
...
tags:
  ...
  status: draft
  commons_alignment: 3
generalizes_from: ["pat_01kg502408eg1s5s6d64g2rn6t"]
specializes_to: []
enables: []
requires: []
related: []
...
1.  [What is TCA?](https://tcaaccelerator.org/what-is-tca/) - True Cost Accounting Accelerator
2.  [True cost accounting](https://en.wikipedia.org/wiki/True_cost_accounting) - Wikipedia
3.  [True Cost Accounting • True Cost – From Costs to Benefits in ...](https://tca2f.org/)
4.  [True Cost Accounting](https://sustainablefoodtrust.org/our-work/true-cost-accounting/) - Sustainable Food Trust
5.  [Leveraging true cost accounting: a two-phase assessment](https://www.fao.org/3/cc7724en/online/state-of-food-and-agriculture-2023/true-cost-accounting-assessment.html) - Food and Agriculture Organization of the United Nations
6.  [True Cost Accounting: Implementation Guidance and ...](https://futureoffood.org/publication-library/true-cost-accounting-implementation-guidance-and-inventory/) - Global Alliance for the Future of Food
7.  [True Cost Accounting (TCA) Alliance](https://www.tmg-thinktank.com/projects/true-cost-accounting-tca-alliance)
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/true-cost-accounting-externalities-included.md)
