---
id: pat_01kg5023xaemr9xsmcrs0gz2vg
page_url: https://commons-os.github.io/patterns/domain/aggregator-model/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/aggregator-model.md
slug: aggregator-model
title: Aggregator Model
aliases: [Platform Business Model, Network Model]
version: 1.0
...
- **Page URL**: [https://commons-os.github.io/patterns/domain/aggregator-model/](https://commons-os.github.io/patterns/domain/aggregator-model/)
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/aggregator-model.md)
- **Edit**: [Edit this pattern](https://github.com/commons-os/patterns/edit/main/_domain/aggregator-model.md)
