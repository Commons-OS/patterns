---
id: pat_01kg5023zseyh85cxgf1b017b3
page_url: https://commons-os.github.io/patterns/domain/reggio-emilia-approach/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/reggio-emilia-approach.md
...
-   **Documented Outcomes**:
    ...
    -   **Health**: Lower rates of obesity [3].
...
-   **Human-Machine Balance**:
    In a Reggio-inspired context, technology is a tool in service of learning, not an end in itself. The uniquely human aspects of the approach remain paramount:
...
-   **References**:
    [1] Reggio Children. (n.d.). *Reggio Emilia Approach*. Retrieved from https://www.reggiochildren.it/en/reggio-emilia-approach/
    [2] Wikipedia. (2023). *Reggio Emilia approach*. Retrieved from https://en.wikipedia.org/wiki/Reggio_Emilia_approach
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/reggio-emilia-approach.md)
