...
page_url: https://commons-os.github.io/patterns/domain/30-event-driven-architecture/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/30-event-driven-architecture.md
slug: 30-event-driven-architecture
title: Event-Driven Architecture
aliases: [EDA, Event-Based Architecture]
version: 1.0
...
tags:
  universality: domain
  domain: design
  category: [architecture, meta-pattern]
  era: [digital]
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/30-event-driven-architecture.md)
