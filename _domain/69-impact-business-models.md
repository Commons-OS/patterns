---
id: pat_01kg5023wjfg8tqb1zgxc17gqn
page_url: https://commons-os.github.io/patterns/domain/69-impact-business-models/
github_url: https://github.com/commons-os/patterns/blob/main/_domain/69-impact-business-models.md
slug: 69-impact-business-models
title: Impact Business Models
aliases: []
version: 1.0
...
1.  **Conduct a Baseline Assessment**: Use a tool like the B Impact Assessment to get a baseline understanding of the company's current social and environmental performance. This will help identify areas for improvement and set a starting point for the journey.
2.  **Engage Stakeholders in the Design Process**: Involve key stakeholders, including employees, customers, and community members, in the process of designing the new business model. This will ensure that the model is relevant, effective, and has broad support.
3.  **Start Small and Iterate**: It is not necessary to change everything at once. Start with a pilot project or a single product line to test the new model and learn from the experience. Use a lean, iterative approach to refine the model over time.
4.  **Formalize the Commitment**: Once the model has been proven, formalize the commitment by adopting a legal structure like a Benefit Corporation or seeking B Corp certification. This will help protect the mission and signal the company's commitment to stakeholders.
...
- **Source**: [View on GitHub](https://github.com/commons-os/patterns/blob/main/_domain/69-impact-business-models.md)
